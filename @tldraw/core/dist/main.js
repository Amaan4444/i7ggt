// "@tldraw/core "../../../@tldraw/vec "../../../@tldraw/intersect  "@tldraw/tldraw" top import
...
import { Vec as Vec6 } from "../../../@tldraw/vec";
...
import { autorun as autorun2 } from "mobx";
...
function useZoomEvents(zoomRef, ref) {
  ...
  const handleWheel = React2.useCallback(({ event: e }) => {
    ...
    const delta = Vec2.mul(e.shiftKey && !utils_default.isDarwin ? [offset[1], 0] : [...offset], 0.5);
  ...
  const animateNext = React15.useCallback((animation) => {
    ...
    function loop() {
      ...
      if (t <= 1) {
        ...
        if (!elm)
          return;
        const point2 = animation.curve ? spline.getSplinePoint(t + animation.start) : Vec4.lrp(animation.from, animation.to, t);
...
var Spline = class {
  ...
  addPoint(point) {
    if (this.prev) {
      const length = Vec4.dist(this.prev, point);
...
var Brush = observer2(function Brush2({ brush, zoom, dashed }) {
...
var SVGContainer = React26.forwardRef(function SVGContainer2(_a, ref) {
  ...
  return /* @__PURE__ */ React26.createElement(Observer, null, () => /* @__PURE__ */ React26.createElement("svg", __spreadValues({
    ref,
...
var BoundsBg = observer9(function BoundsBg2({ bounds, rotation, isHidden }) {
...
// src/components/Handles/Handles.tsx
var Handles = observer11(function Handles2({ shape, zoom }) {
  if (shape.handles === void 0) {
    return null;
  }
  let prev = null;
  const handlesToShow = Object.values(shape.handles).reduce((acc, cur) => {
    const point = Vec5.add(cur.point, shape.point);
    if (!prev || Vec5.dist(point, prev) * zoom >= 32) {
      acc.push(cur);
      prev = point;
    }
    return acc;
  ...
  return /* @__PURE__ */ React30.createElement(React30.Fragment, null, handlesToShow.map((handle) => /* @__PURE__ */ React30.createElement(Handle, {
    ...
    id: handle.id,
    point: Vec5.add(handle.point, shape.point)
  })));
});
...
var EraseLine = observer19(function EraserLine({ points, zoom }) {
  if (points.length === 0)
    return null;
  const d = utils_default.getSvgPathFromStroke(getStroke(points, { size: 16 / zoom, start: { taper: true } }));
...
// src/components/Canvas/Canvas.tsx
var Canvas = observer20(function _Canvas({
  id,
  page,
  pageState,
  assets,
...
var Inputs = class {
  ...
  touchMove(e, target) {
    ...
    const delta = (prev == null ? void 0 : prev.point) ? Vec6.sub(point, prev.point) : [0, 0];
  ...
  isDoubleClick() {
    ...
    const isDoubleClick = performance.now() - this.pointerUpTime < DOUBLE_CLICK_DURATION && Vec6.dist(origin, point) < 4;
    if (isDoubleClick)
      this.activePointer = void 0;
  ...
  pinch(point, origin) {
    ...
    const delta = Vec6.sub(origin, point);
    const info = {
      pointerId: 0,
      target: "pinch",
      origin,
      delta,
      point: Vec6.sub(Vec6.toFixed(point), [this.bounds.minX, this.bounds.minY]),
      pressure: 0.5,
      shiftKey,
      ctrlKey,
      metaKey: Utils.isDarwin() ? metaKey : ctrlKey,
...
// src/components/Renderer/Renderer.tsx
var Renderer = observer21(function _Renderer(_a) {
  var _b = _a, {
    id = "tl",
    shapeUtils,
    page,
...
var HTMLContainer = React46.forwardRef(function HTMLContainer2(_a, ref) {
  ...
  return /* @__PURE__ */ React46.createElement(Observer2, null, () => /* @__PURE__ */ React46.createElement("div", __spreadValues({
    ref,
