...
var import_core56 = require("../../../@tldraw/core");
...
var stickyFills = {
  light: __spreadProps(__spreadValues({}, fromEntriesMod(Object.entries(colors).map(([k, v]) => [k, import_core.Utils.lerpColor(v, canvasLight, 0.45)]))), {
    ["white" /* White */]: "#ffffff",
    ["black" /* Black */]: "#3d3d3d"
  }),
  dark: __spreadProps(__spreadValues({}, fromEntriesMod(Object.entries(colors).map(([k, v]) => [
    k,
...
var strokes = {
  ...
  dark: __spreadProps(__spreadValues({}, fromEntriesMod(Object.entries(colors).map(([k, v]) => [k, import_core.Utils.lerpColor(v, canvasDark, 0.1)]))), {
    ["white" /* White */]: "#cecece",
    ["black" /* Black */]: "#cecece"
  })
};
var fills = {
  light: __spreadProps(__spreadValues({}, fromEntriesMod(Object.entries(colors).map(([k, v]) => [k, import_core.Utils.lerpColor(v, canvasLight, 0.82)]))), {
    ["white" /* White */]: "#fefefe"
  }),
  dark: __spreadProps(__spreadValues({}, fromEntriesMod(Object.entries(colors).map(([k, v]) => [k, import_core.Utils.lerpColor(v, canvasDark, 0.82)]))), {
...
function getTextSvgElement(text4, style, bounds) {
  var _a;
  const fontSize = getFontSize(style.size, style.font);
  const g = document.createElementNS("http://www.w3.org/2000/svg", "g");
  const scale = (_a = style.scale) != null ? _a : 1;
  const textLines = text4.split("\n").map((line, i) => {
...
function getTextLabelSize(text4, font) {
  if (!text4) {
    return [16, 32];
  }
  if (!melm) {
  ...
  if (text4 === prevText && font === prevFont) {
    return prevSize;
  }
  prevText = text4;
  prevFont = font;
  melm.textContent = text4;
...
var TextAreaUtils = class {
  static insertTextFirefox(field, text4) {
    field.setRangeText(text4, field.selectionStart || 0, field.selectionEnd || 0, "end");
  ...
  static insert(field, text4) {
    const document2 = field.ownerDocument;
    const initialFocus = document2.activeElement;
    if (initialFocus !== field) {
      field.focus();
    }
    if (!document2.execCommand("insertText", false, text4)) {
      TextAreaUtils.insertTextFirefox(field, text4);
    }
  ...
  static set(field, text4) {
    field.select();
    TextAreaUtils.insert(field, text4);
  }
...
// src/state/shapes/shared/TextLabel.tsx
var TextLabel = React.memo(function TextLabel2({
  font,
  text: text4,
  color,
  offsetX = 0,
  ...
  React.useLayoutEffect(() => {
    ...
    if (!elm)
      return;
    const size = getTextLabelSize(text4, font);
  ...
  }, [text4, font, offsetY, offsetX, scale]);
  return /* @__PURE__ */ React.createElement(TextWrapper, null, /* @__PURE__ */ React.createElement(InnerWrapper, {
    ref: rInnerWrapper,
    hasText: !!text4,
    isEditing,
    style: {
...
function getRectangleDrawPoints(id, style, size) {
  const styles5 = getShapeStyle(style);
  const getRandom = import_core4.Utils.rng(id);
  const sw = styles5.strokeWidth;
...
var DrawRectangle = React3.memo(function DrawRectangle2({
  id,
  style,
  size,
  isSelected,
  ...
  return /* @__PURE__ */ React3.createElement(React3.Fragment, null, /* @__PURE__ */ React3.createElement("path", {
    className: style.isFilled || isSelected ? "tl-fill-hitarea" : "tl-stroke-hitarea",
    d: innerPath
  }), isFilled && /* @__PURE__ */ React3.createElement("path", {
    d: innerPath,
    fill,
    pointerEvents: "none"
...
var DashedRectangle = React4.memo(function DashedRectangle2({
  id,
  style,
  size,
  isSelected,
  ...
  const paths = strokes2.map(([start, end, length], i) => {
    ...
    return /* @__PURE__ */ React4.createElement("line", {
      key: id + "_" + i,
      x1: start[0],
      y1: start[1],
      x2: end[0],
  ...
  return /* @__PURE__ */ React4.createElement(React4.Fragment, null, /* @__PURE__ */ React4.createElement("rect", {
  ...
  }), style.isFilled && /* @__PURE__ */ React4.createElement("rect", {
    x: sw / 2,
    y: sw / 2,
    width: w,
    height: h,
...
function BindingIndicator({ strokeWidth, size }) {
  return /* @__PURE__ */ React5.createElement("rect", {
...
var RectangleUtil = class extends TDShapeUtil {
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({
      ...
      const styles5 = getShapeStyle(style, meta.isDarkMode);
      const Component = style.dash === "draw" /* Draw */ ? DrawRectangle : DashedRectangle;
      const handleLabelChange = React6.useCallback((label2) => onShapeChange == null ? void 0 : onShapeChange({ id, label: label2 }), [onShapeChange]);
      return /* @__PURE__ */ React6.createElement(FullWrapper, __spreadValues({
        ref
      }, events), /* @__PURE__ */ React6.createElement(TextLabel, {
        isEditing,
        onChange: handleLabelChange,
        onBlur: onShapeBlur,
        font,
        text: label,
        color: styles5.stroke,
        offsetX: (labelPoint[0] - 0.5) * bounds.width,
        offsetY: (labelPoint[1] - 0.5) * bounds.height
      }), /* @__PURE__ */ React6.createElement(import_core6.SVGContainer, {
        id: shape.id + "_svg",
        opacity: isGhost ? GHOSTED_OPACITY : 1
      }, isBinding && /* @__PURE__ */ React6.createElement(BindingIndicator, {
        strokeWidth: styles5.strokeWidth,
        size
      }), /* @__PURE__ */ React6.createElement(Component, {
        id,
        style,
        size,
        isSelected,
    ...
    __publicField(this, "Indicator", TDShapeUtil.Indicator(({ shape }) => {
      ...
      const styles5 = getShapeStyle(style, false);
      const sw = styles5.strokeWidth;
...
var DrawTriangle = React7.memo(function DrawTriangle2({
  id,
  size,
  style,
  isSelected,
  ...
  return /* @__PURE__ */ React7.createElement(React7.Fragment, null, /* @__PURE__ */ React7.createElement("path", {
    className: style.isFilled || isSelected ? "tl-fill-hitarea" : "tl-stroke-hitarea",
    d: indicatorPath
  }), style.isFilled && /* @__PURE__ */ React7.createElement("path", {
    d: indicatorPath,
    fill,
    pointerEvents: "none"
...
var DashedTriangle = React8.memo(function DashedTriangle2({
  id,
  size,
  style,
  isSelected,
  ...
  const paths = sides.map(([start, end], i) => {
    ...
    return /* @__PURE__ */ React8.createElement("line", {
      key: id + "_" + i,
      x1: start[0],
      y1: start[1],
      x2: end[0],
  ...
  return /* @__PURE__ */ React8.createElement(React8.Fragment, null, /* @__PURE__ */ React8.createElement("polygon", {
    className: style.isFilled || isSelected ? "tl-fill-hitarea" : "tl-stroke-hitarea",
    points: bgPath
  }), style.isFilled && /* @__PURE__ */ React8.createElement("polygon", {
    fill,
    points: bgPath,
    pointerEvents: "none"
...
function TriangleBindingIndicator({ size }) {
  ...
  return /* @__PURE__ */ React9.createElement("polygon", {
    className: "tl-binding-indicator",
...
var TriangleUtil = class extends TDShapeUtil {
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({
      ...
      const handleLabelChange = React10.useCallback((label2) => onShapeChange == null ? void 0 : onShapeChange({ id, label: label2 }), [onShapeChange]);
      const offsetY = React10.useMemo(() => {
        const center = import_vec8.default.div(size, 2);
        const centroid = getTriangleCentroid(size);
        return (centroid[1] - center[1]) * 0.72;
      }, [size]);
      return /* @__PURE__ */ React10.createElement(FullWrapper2, __spreadValues({
        ref
      }, events), /* @__PURE__ */ React10.createElement(TextLabel, {
        font,
        text: label,
        color: styles5.stroke,
        offsetX: (labelPoint[0] - 0.5) * bounds.width,
        ...
        onChange: handleLabelChange,
        onBlur: onShapeBlur
      }), /* @__PURE__ */ React10.createElement(import_core9.SVGContainer, {
        id: shape.id + "_svg",
        opacity: isGhost ? GHOSTED_OPACITY : 1
      }, isBinding && /* @__PURE__ */ React10.createElement(TriangleBindingIndicator, {
        size
      }), /* @__PURE__ */ React10.createElement(Component, {
        id,
        style,
        size,
        isSelected,
...
var DrawEllipse = React11.memo(function DrawEllipse2({
  id,
  radius,
  style,
  isSelected,
  ...
  return /* @__PURE__ */ React11.createElement(React11.Fragment, null, /* @__PURE__ */ React11.createElement("ellipse", {
    className: style.isFilled || isSelected ? "tl-fill-hitarea" : "tl-stroke-hitarea",
    cx: radius[0],
    cy: radius[1],
    rx: radius[0],
    ry: radius[1]
  }), style.isFilled && /* @__PURE__ */ React11.createElement("path", {
...
var DashedEllipse = React12.memo(function DashedEllipse2({
  radius,
  style,
  isSelected,
  isDarkMode
...
var EllipseUtil = class extends TDShapeUtil {
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({
      ...
      const font = getFontStyle(shape.style);
      const styles5 = getShapeStyle(style, meta.isDarkMode);
      const strokeWidth = styles5.strokeWidth;
      const sw = 1 + strokeWidth * 1.618;
      const rx = Math.max(0, radius[0] - sw / 2);
      const ry = Math.max(0, radius[1] - sw / 2);
      const Component = style.dash === "draw" /* Draw */ ? DrawEllipse : DashedEllipse;
      const handleLabelChange = React13.useCallback((label2) => onShapeChange == null ? void 0 : onShapeChange({ id, label: label2 }), [onShapeChange]);
      return /* @__PURE__ */ React13.createElement(FullWrapper3, __spreadValues({
        ref
      }, events), /* @__PURE__ */ React13.createElement(TextLabel, {
        isEditing,
        onChange: handleLabelChange,
        onBlur: onShapeBlur,
        font,
        ...
        offsetX: (labelPoint[0] - 0.5) * bounds.width,
        offsetY: (labelPoint[1] - 0.5) * bounds.height
      }), /* @__PURE__ */ React13.createElement(import_core12.SVGContainer, {
        id: shape.id + "_svg",
        opacity: isGhost ? GHOSTED_OPACITY : 1
      }, isBinding && /* @__PURE__ */ React13.createElement("ellipse", {
        className: "tl-binding-indicator",
        cx: radius[0],
        cy: radius[1],
        rx,
      ...
      }), /* @__PURE__ */ React13.createElement(Component, {
        id,
        radius,
        style,
        isSelected,
    ...
    __publicField(this, "Indicator", TDShapeUtil.Indicator(({ shape }) => {
      ...
      const rx = Math.max(0, radius[0] - sw / 2);
      const ry = Math.max(0, radius[1] - sw / 2);
      return style.dash === "draw" /* Draw */ ? /* @__PURE__ */ React13.createElement("path", {
        d: getEllipseIndicatorPath(id, radius, style)
...
function Arrowhead({ left, middle, right, stroke, strokeWidth }) {
  return /* @__PURE__ */ React14.createElement("g", null, /* @__PURE__ */ React14.createElement("path", {
...
// src/state/shapes/ArrowUtil/components/StraightArrow.tsx
var StraightArrow = React15.memo(function StraightArrow2({
  id,
  style,
  start,
  end,
  ...
  if (arrowDist < 2)
    return null;
  const styles5 = getShapeStyle(style, isDarkMode);
  const { strokeWidth } = styles5;
  const sw = 1 + strokeWidth * 1.618;
  ...
  return /* @__PURE__ */ React15.createElement(React15.Fragment, null, /* @__PURE__ */ React15.createElement("path", {
    className: "tl-stroke-hitarea",
    d: path
  }), /* @__PURE__ */ React15.createElement("path", {
    d: path,
    fill: styles5.stroke,
    stroke: styles5.stroke,
    ...
    strokeLinejoin: "round",
    pointerEvents: "stroke"
  }), startArrowHead && /* @__PURE__ */ React15.createElement(Arrowhead, {
    left: startArrowHead.left,
    middle: start,
    right: startArrowHead.right,
    stroke: styles5.stroke,
    strokeWidth: sw
  }), endArrowHead && /* @__PURE__ */ React15.createElement(Arrowhead, {
...
var CurvedArrow = React16.memo(function CurvedArrow2({
  id,
  style,
  start,
  bend,
  ...
  return /* @__PURE__ */ React16.createElement(React16.Fragment, null, /* @__PURE__ */ React16.createElement("path", {
    ...
    d: path,
    fill: isDraw ? styles5.stroke : "none",
    stroke: styles5.stroke,
...
function LabelMask({ id, bounds, labelSize, offset, scale = 1 }) {
  return /* @__PURE__ */ React17.createElement("defs", null, /* @__PURE__ */ React17.createElement("mask", {
    id: id + "_clip"
...
var ArrowUtil = class extends TDShapeUtil {
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({ shape, isEditing, isGhost, meta, events, onShapeChange, onShapeBlur }, ref) => {
      ...
      const handleLabelChange = React18.useCallback((label2) => {
        onShapeChange == null ? void 0 : onShapeChange({ id, label: label2 });
      }, [onShapeChange]);
      const Component = isStraightLine ? StraightArrow : CurvedArrow;
      return /* @__PURE__ */ React18.createElement(FullWrapper4, __spreadValues({
        ref
      }, events), /* @__PURE__ */ React18.createElement(TextLabel, {
        font,
        text: label,
        color: styles5.stroke,
        offsetX: offset[0],
        ...
        onChange: handleLabelChange,
        onBlur: onShapeBlur
      }), /* @__PURE__ */ React18.createElement(import_core16.SVGContainer, {
        id: shape.id + "_svg"
      }, /* @__PURE__ */ React18.createElement("defs", null, /* @__PURE__ */ React18.createElement("mask", {
        id: shape.id + "_clip"
      ...
      }, /* @__PURE__ */ React18.createElement(Component, {
        id,
        style,
        start: start.point,
        end: end.point,
    ...
    __publicField(this, "Indicator", TDShapeUtil.Indicator(({ shape, bounds }) => {
      ...
      return /* @__PURE__ */ React18.createElement(React18.Fragment, null, /* @__PURE__ */ React18.createElement(LabelMask, {
        id: shape.id,
        scale,
        offset,
        bounds,
      ...
      }), label && /* @__PURE__ */ React18.createElement("rect", {
        x: bounds.width / 2 - labelSize[0] / 2 * scale + offset[0],
        y: bounds.height / 2 - labelSize[1] / 2 * scale + offset[1],
        width: labelSize[0] * scale,
        height: labelSize[1] * scale,
  ...
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({ shape, isBinding, isGhost, isHovered, isSelected, events }, ref) => {
      ...
      const paths = strokes2.map(([start, end], i) => {
        return /* @__PURE__ */ React19.createElement("line", {
          key: id + "_" + i,
          x1: start[0],
          y1: start[1],
          x2: end[0],
      ...
      return /* @__PURE__ */ React19.createElement(import_core17.SVGContainer, __spreadValues({
        ref
      }, events), isBinding && /* @__PURE__ */ React19.createElement("rect", {
        className: "tl-binding-indicator",
        strokeWidth: this.bindingDistance
        ...
        fill: "transparent",
        pointerEvents: "all"
      }), /* @__PURE__ */ React19.createElement(ScaledLines, {
        stroke: "black" /* Black */,
    ...
    __publicField(this, "Indicator", TDShapeUtil.Indicator(({ shape }) => {
      ...
      return /* @__PURE__ */ React19.createElement(ScaledLines, {
        strokeLinecap: "round",
        pointerEvents: "stroke"
      }, paths);
    }));
...
var StickyUtil = class extends TDShapeUtil {
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({ shape, meta, events, isGhost, isBinding, isEditing, onShapeBlur, onShapeChange }, ref) => {
      ...
      const rContainer = React20.useRef(null);
      const rTextArea = React20.useRef(null);
      const rText = React20.useRef(null);
      const rIsMounted = React20.useRef(false);
      const handlePointerDown = React20.useCallback((e) => {
        e.stopPropagation();
      }, []);
      const onChange = React20.useCallback((text4) => {
        onShapeChange == null ? void 0 : onShapeChange({
          id: shape.id,
          type: shape.type,
          text: TLDR.normalizeText(text4)
        });
      }, [shape.id]);
      const handleTextChange = React20.useCallback((e) => {
      ...
      const handleFocus = React20.useCallback((e) => {
        if (!isEditing)
          return;
        if (!rIsMounted.current)
          return;
      ...
      React20.useEffect(() => {
        const text4 = rText.current;
        const { size } = shape;
        const { offsetHeight: currTextHeight } = text4;
      ...
      return /* @__PURE__ */ React20.createElement(import_core18.HTMLContainer, __spreadValues({
        ref
      }, events), /* @__PURE__ */ React20.createElement(StyledStickyContainer, {
        ref: rContainer,
        isDarkMode: meta.isDarkMode,
        isGhost,
        style: __spreadValues({ backgroundColor: fill }, style)
      }, isBinding && /* @__PURE__ */ React20.createElement("div", {
        className: "tl-binding-indicator",
        style: {
          position: "absolute",
      ...
      }), /* @__PURE__ */ React20.createElement(StyledText, {
        ref: rText,
        isEditing,
        alignment: shape.style.textAlign
      }, shape.text, "\u200B"), isEditing && /* @__PURE__ */ React20.createElement(StyledTextArea, {
        ref: rTextArea,
        onPointerDown: handlePointerDown,
        value: shape.text,
    ...
    __publicField(this, "Indicator", TDShapeUtil.Indicator(({ shape }) => {
      ...
      return /* @__PURE__ */ React20.createElement("rect", {
        x: 0,
        y: 0,
        rx: 3,
        ry: 3,
...
var TextUtil = class extends TDShapeUtil {
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({ shape, isBinding, isGhost, isEditing, onShapeBlur, onShapeChange, meta, events }, ref) => {
      const { text: text4, style } = shape;
      const styles5 = getShapeStyle(style, meta.isDarkMode);
      const font = getFontStyle(shape.style);
      const rInput = React21.useRef(null);
      const rIsMounted = React21.useRef(false);
      const handleChange = React21.useCallback((e) => {
        let delta = [0, 0];
      ...
      return /* @__PURE__ */ React21.createElement(import_core19.HTMLContainer, __spreadValues({
        ref
      }, events), /* @__PURE__ */ React21.createElement(Wrapper, {
        isGhost,
        isEditing,
        onPointerDown: handlePointerDown
      }, /* @__PURE__ */ React21.createElement(InnerWrapper2, {
        style: {
          font,
          color: styles5.stroke,
      ...
      }), isEditing ? /* @__PURE__ */ React21.createElement(TextArea2, {
        ref: rInput,
        style: {
          font,
          color: styles5.stroke
...
function getFreehandOptions(shape) {
  const styles5 = getShapeStyle(shape.style);
  const options2 = __spreadProps(__spreadValues({
    size: 1 + styles5.strokeWidth * 1.5,
    thinning: 0.65,
    streamline: 0.65,
    smoothing: 0.65
...
var DrawUtil = class extends TDShapeUtil {
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({ shape, meta, isSelected, isGhost, events }, ref) => {
      ...
      const polygonPathTDSnapshot = React22.useMemo(() => {
        return getFillPath(shape);
      }, [points, style.size]);
      const pathTDSnapshot = React22.useMemo(() => {
      ...
      const styles5 = getShapeStyle(style, meta.isDarkMode);
      const { stroke, fill, strokeWidth } = styles5;
      const bounds = this.getBounds(shape);
      const verySmall = bounds.width <= strokeWidth / 2 && bounds.height <= strokeWidth / 2;
      if (verySmall) {
        const sw2 = 1 + strokeWidth;
        return /* @__PURE__ */ React22.createElement(import_core21.SVGContainer, __spreadValues({
          ref,
          id: shape.id + "_svg"
        }, events), /* @__PURE__ */ React22.createElement("circle", {
          r: sw2,
          fill: stroke,
          stroke,
          pointerEvents: "all",
    ...
    __publicField(this, "Indicator", TDShapeUtil.Indicator(({ shape }) => {
      ...
      if (verySmall) {
        return /* @__PURE__ */ React22.createElement("circle", {
          x: bounds.width / 2,
          y: bounds.height / 2,
          r: 1
        });
      }
      return /* @__PURE__ */ React22.createElement("path", {
        d: pathTDSnapshot
      });
    }));
    __publicField(this, "transform", (shape, bounds, { initialShape, scaleX, scaleY }) => {
    ...
    __publicField(this, "hitTestLineSegment", (shape, A, B) => {
      ...
      if (bounds.width < 8 && bounds.height < 8) {
        return import_vec17.Vec.distanceToLineSegment(A, B, import_core21.Utils.getBoundsCenter(bounds)) < 5;
      }
...
var ImageUtil = class extends TDShapeUtil {
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({ shape, asset = { src: "" }, isBinding, isGhost, meta, events, onShapeChange }, ref) => {
      ...
      const rImage = React23.useRef(null);
      const rWrapper = React23.useRef(null);
      ...
      return /* @__PURE__ */ React23.createElement(import_core22.HTMLContainer, __spreadValues({
        ref
      }, events), isBinding && /* @__PURE__ */ React23.createElement("div", {
        className: "tl-binding-indicator",
        style: {
          position: "absolute",
      ...
      }), /* @__PURE__ */ React23.createElement(Wrapper2, {
        ref: rWrapper,
        isDarkMode: meta.isDarkMode,
        isFilled: style.isFilled,
        isGhost
      }, /* @__PURE__ */ React23.createElement(ImageElement, {
        id: shape.id + "_image",
        ref: rImage,
        src: asset.src,
        alt: "tl_image_asset",
    ...
    __publicField(this, "Indicator", TDShapeUtil.Indicator(({ shape }) => {
      ...
      return /* @__PURE__ */ React23.createElement("rect", {
        x: 0,
        y: 0,
        rx: 2,
        ry: 2,
    ...
    __publicField(this, "getSvgElement", (shape) => {
      ...
      elm.setAttribute("xmlnsXlink", `http://www.w3.org/1999/xlink`);
      return elm;
    });
  }
};
...
var VideoUtil = class extends TDShapeUtil {
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({ shape, asset = { src: "" }, isBinding, isEditing, isGhost, meta, events, onShapeChange }, ref) => {
      const rVideo = React24.useRef(null);
      ...
      const handlePause = React24.useCallback(() => {
        onShapeChange == null ? void 0 : onShapeChange({ id: shape.id, isPlaying: false });
      }, []);
      const handleSetCurrentTime = React24.useCallback(() => {
        const video = rVideo.current;
        if (!video)
          return;
        if (!isEditing)
      ...
      return /* @__PURE__ */ React24.createElement(import_core23.HTMLContainer, __spreadValues({
        ref
      ...
      }), /* @__PURE__ */ React24.createElement(Wrapper3, {
        ref: rWrapper,
        isDarkMode: meta.isDarkMode,
        isGhost,
        isFilled: style.isFilled
      }, /* @__PURE__ */ React24.createElement(VideoElement, {
        ref: rVideo,
        id: shape.id + "_video",
        muted: true,
        loop: true,
      ...
      }, /* @__PURE__ */ React24.createElement("source", {
        src: asset.src
      }))));
    }));
    __publicField(this, "Indicator", TDShapeUtil.Indicator(({ shape }) => {
...
var _TLDR = class {
    ...
    while (idsToCheck.length) {
      ...
      arrows.forEach((arrow4) => {
        ...
        if (startBinding && startBinding.toId === id) {
          if (direction === "center") {
            hit = true;
          } else if (((_a = arrow4.decorations) == null ? void 0 : _a.start) && endBinding) {
            hit = direction === "left";
          } else {
            hit = direction === "right";
          }
          ...
          if (direction === "center") {
            hit = true;
          } else if (((_b = arrow4.decorations) == null ? void 0 : _b.end) && startBinding) {
            hit = direction === "left";
          } else {
            hit = direction === "right";
          }
  ...
  static getBeforeShape(shape, change) {
    return fromEntriesMod(Object.keys(change).map((k) => [k, shape[k]]));
  }
  ...
  static createShapes(data, shapes, pageId) {
    const before = {
      document: {
        pages: {
          [pageId]: {
            shapes: __spreadValues({}, fromEntriesMod(shapes.flatMap((shape) => {
  ...
  static deleteShapes(data, shapes, pageId) {
    ...
    const before = {
      document: {
        pages: {
          [pageId]: {
            shapes: __spreadValues({}, fromEntriesMod(shapeIds.flatMap((id) => {
              const shape = page.shapes[id];
              const results = [[shape.id, shape]];
              if (shape.parentId !== pageId) {
                const parent = page.shapes[shape.parentId];
            ...
            bindings: __spreadValues({}, fromEntriesMod(Object.values(page.bindings).filter((binding) => {
    ...
    for (const ID2 of ["end", "start"]) {
      ...
      if (A.isBound) {
        if (!A.binding.distance) {
          result[ID2].point = import_vec18.Vec.sub(A.point, arrowShape.point);
        } else {
          ...
          switch (A.target.type) {
            case "ellipse" /* Ellipse */: {
              ...
              if (hits[0] !== void 0) {
                result[ID2].point = import_vec18.Vec.toFixed(import_vec18.Vec.sub(hits[0], arrowShape.point));
              }
              break;
            }
            ...
            default: {
              ...
              if (B.isBound && (hits.length < 2 || bHit && hits[0] && Math.ceil(import_vec18.Vec.dist(hits[0], bHit)) < BINDING_DISTANCE * 2.5 || import_core24.Utils.boundsContain(A.expandedBounds, B.expandedBounds) || import_core24.Utils.boundsCollide(A.expandedBounds, B.expandedBounds))) {
                ...
                if (!shortArrowHits[0])
                  continue;
                result[ID2].point = import_vec18.Vec.toFixed(import_vec18.Vec.sub(shortArrowHits[0], arrowShape.point));
  ...
  static getRotatedShapeMutation(shape, center, origin, delta) {
    ...
    if (shape.handles !== void 0) {
      const change = (_b = (_a = this.getShapeUtil(shape)).onHandleChange) == null ? void 0 : _b.call(_a, __spreadProps(__spreadValues({}, shape), { point: nextPoint }), fromEntriesMod(Object.entries(shape.handles).map(([handleId, handle]) => {
  ...
  static normalizeText(text4) {
    return text4.replace(_TLDR.fixNewLines, "\n").split("\n").map((x) => x || " ").join("\n");
  }
...
function alignShapes(app, ids, type) {
  ...
  const deltaMap = fromEntriesMod(boundsForShapes.map(({ id, point, bounds }) => {
    return [
      id,
      {
        prev: point,
...
function distributeShapes(app, ids, type) {
  const { currentPageId } = app;
  const initialShapes = ids.map((id) => app.getShape(id));
  const deltaMap = fromEntriesMod(getDistributions(initialShapes, type).map((d) => [d.id, d]));
...
function duplicatePage(app, pageId) {
  ...
  const nextPage = __spreadProps(__spreadValues({}, page), {
    id: newId,
    name: page.name + " Copy",
    shapes: fromEntriesMod(Object.entries(page.shapes).map(([id, shape]) => {
      return [
        id,
...
function groupShapes(app, ids, groupId, pageId) {
  ...
  const shapeIndexMap = fromEntriesMod(shapesToGroup.map((shape) => [shape.id, flattenedShapes.indexOf(shape)]));
...
function styleShapes(app, ids, changes) {
  ...
  shapeIdsToMutate.map((id) => app.getShape(id)).filter((shape) => !shape.isLocked).forEach((shape) => {
    beforeShapes[shape.id] = {
      style: __spreadValues({}, fromEntriesMod(Object.keys(changes).map((key) => [key, shape.style[key]])))
    };
...
function toggleShapesDecoration(app, ids, decorationId) {
  const { currentPageId, selectedIds } = app;
  const beforeShapes = fromEntriesMod(ids.map((id) => {
    var _a;
    return [
      id,
      {
  ...
  const afterShapes = fromEntriesMod(ids.filter((id) => !app.getShape(id).isLocked).map((id) => {
    var _a;
    return [
      id,
      {
...
function setShapesProps(app, ids, partial) {
  ...
  initialShapes.forEach((shape) => {
    before[shape.id] = fromEntriesMod(keys.map((key) => [key, shape[key]]));
...
var TransformSession = class extends BaseSession {
  constructor(app, transformType = import_core39.TLBoundsCorner.BottomRight, isCreate = false) {
    ...
    const shapesBounds = fromEntriesMod(this.initialShapes.map((shape) => [shape.id, TLDR.getBounds(shape)]));
...
var EraseSession = class extends BaseSession {
  constructor(app) {
    ...
    __publicField(this, "update", () => {
      ...
      if (shiftKey) {
        if (!this.isLocked && import_vec32.Vec.dist(originPoint, currentPoint) > 4 / zoom) {
          if (!this.lockedDirection) {
      ...
      return {
        document: {
          pages: {
            [page.id]: {
              shapes: fromEntriesMod(erasedShapes.map((shape) => [shape.id, { isGhost: true }]))
            }
          }
        }
      };
    ...
    __publicField(this, "cancel", () => {
      ...
      return {
        document: {
          pages: {
            [page.id]: {
              shapes: fromEntriesMod(erasedShapes.map((shape) => [shape.id, { isGhost: false }]))
            }
          },
          pageStates: {
            [page.id]: {
    ...
    __publicField(this, "complete", () => {
      ...
      const before = {
        shapes: fromEntriesMod(erasedShapes.map((shape) => [shape.id, shape])),
        bindings: fromEntriesMod(erasedBindings.map((binding) => [binding.id, binding]))
      };
      const after = {
        shapes: fromEntriesMod(erasedShapes.map((shape) => [shape.id, void 0])),
        bindings: fromEntriesMod(erasedBindings.map((binding) => [binding.id, void 0]))
      };
...
var GridSession = class extends BaseSession {
  constructor(app, id) {
    ...
    __publicField(this, "getClone", (point, copy4) => {
...
function getClipboard() {
  return __async(this, null, function* () {
    return (0, import_idb_keyval2.get)(ID);
  });
}
function setClipboard(item) {
  return __async(this, null, function* () {
    return (0, import_idb_keyval2.set)(ID, item);
  });
}
...
var _TldrawApp = class extends StateManager {
  constructor(id, callbacks = {}) {
          ...
          if (!prevPage || page.shapes !== prevPage.shapes || page.bindings !== prevPage.bindings) {
            ...
            Object.entries(page.shapes).forEach(([id, shape]) => {
              ...
              if (parentId && parentId !== pageId) {
                const group4 = page.shapes[parentId];
                if (group4 !== void 0) {
            ...
            groupsToUpdate.forEach((group4) => {
              if (!group4)
                throw Error("no group!");
              const children = group4.children.filter((id) => page.shapes[id] !== void 0);
              ...
              page.shapes[group4.id] = __spreadProps(__spreadValues({}, group4), {
    ...
    __publicField(this, "onPatch", (app, id) => {
      var _a, _b;
      (_b = (_a = this.callbacks).onPatch) == null ? void 0 : _b.call(_a, this, id);
    });
    __publicField(this, "onCommand", (app, id) => {
      var _a, _b;
    ...
    __publicField(this, "onStateDidChange", (_app, id) => {
      var _a, _b, _c, _d;
    ...
    __publicField(this, "updateUsers", (users, isOwnUpdate = false) => {
      this.patchState({
        room: {
          users: fromEntriesMod(users.map((user) => [user.id, user]))
        }
    ...
    __publicField(this, "paste", (point, e) => __async(this, null, function* () {
      ...
      const pasteInCurrentPage = (shapes, bindings, assets) => {
        ...
        if (newAssets.length) {
          this.patchState({
            document: {
              assets: fromEntriesMod(newAssets.map((asset) => [asset.id, asset]))
            }
          });
        }
        ...
        const shapesToPaste = shapes.sort((a, b) => a.childIndex - b.childIndex).map((shape) => {
          ...
          const copy4 = __spreadProps(__spreadValues({}, shape), {
            id: idsMap[shape.id],
            parentId: parentShapeId || this.currentPageId
          });
          if (shape.children) {
            copy4.children = shape.children.map((id) => idsMap[id]);
          }
          if (!parentShapeId) {
            copy4.childIndex = startIndex;
            startIndex++;
          }
          if (copy4.handles) {
            Object.values(copy4.handles).forEach((handle) => {
              if (handle.bindingId) {
      ...
      const pasteTextAsSvg = (text4) => __async(this, null, function* () {
      ...
      if (e !== void 0) {
        const items = (_b = (_a = e.clipboardData) == null ? void 0 : _a.items) != null ? _b : [];
        for (const index in items) {
          const item = items[index];
          if (item.type === "text/html") {
            item.getAsString((text4) => __async(this, null, function* () {
              pasteAsHTML(text4);
            }));
            return;
          } else {
            switch (item.kind) {
              case "string": {
                item.getAsString((text4) => __async(this, null, function* () {
                  if (text4.startsWith("<svg")) {
                    pasteTextAsSvg(text4);
                  } else {
                    pasteTextAsShape(text4);
                  }
                }));
      ...
      if (navigator.clipboard) {
        ...
        try {
          for (const item of items) {
            const pngData = yield item.getType("text/png");
            if (pngData) {
              const file = new File([pngData], "image.png");
              this.addMediaFromFile(file);
              return;
            }
            const svgData = yield item.getType("image/svg+xml");
            if (svgData) {
              const file = new File([svgData], "image.svg");
              this.addMediaFromFile(file);
              return;
            }
            const textData = yield item.getType("text/plain");
            if (textData) {
              const text4 = yield textData.text();
              text4.trim();
              if (text4.startsWith("<svg")) {
                pasteTextAsSvg(text4);
              } else {
    ...
    __publicField(this, "exportJson", (ids = this.selectedIds.length ? this.selectedIds : Object.keys(this.page.shapes)) => {
      if (ids.length === 0)
        return;
    ...
    __publicField(this, "getImage", (..._0) => __async(this, [..._0], function* (format = "png" /* PNG */, opts = {}) {
      ...
      const svg = yield this.getSvg(ids, {
        ...
        transparentBackground: format === "png" /* PNG */
      });
      if (!svg)
        return;
      if (format === "svg" /* SVG */) {
    ...
    __publicField(this, "zoomToContent", () => {
      ...
      const mx = (rendererBounds.width - commonBounds.width * zoom) / 2 / zoom;
      const my = (rendererBounds.height - commonBounds.height * zoom) / 2 / zoom;
      return this.setCamera(import_vec43.Vec.toFixed(import_vec43.Vec.sub([mx, my], [commonBounds.minX, commonBounds.minY])), this.camera.zoom, `zoomed_to_content`);
    });
        ...
        if (this.isCreating) {
          result.before = {
            ...
            document: {
              pages: {
                [this.currentPageId]: {
                  shapes: fromEntriesMod(this.selectedIds.map((id) => [id, void 0]))
                }
              },
              pageStates: {
                [this.currentPageId]: {
    ...
    __publicField(this, "onPan", (info, e) => {
      if (this.appState.status === "pinching")
        return;
      const delta = import_vec43.Vec.div(info.delta, this.camera.zoom);
  ...
  getClipboard(ids = this.selectedIds) {
...
function useKeyboardShortcuts(ref) {
  ...
  const canHandleEvent = React25.useCallback((ignoreMenus = false) => {
...
var TldrawContext = React26.createContext({});
function useTldrawApp() {
  const context = React26.useContext(TldrawContext);
  return context;
}
...
function useFileSystemHandlers() {
  const app = useTldrawApp();
  const onNewProject = React28.useCallback((e) => __async(this, null, function* () {
    var _a, _b;
    if (e && app.callbacks.onOpenProject)
      e.preventDefault();
    (_b = (_a = app.callbacks).onNewProject) == null ? void 0 : _b.call(_a, app);
  }), [app]);
  const onSaveProject = React28.useCallback((e) => {
    var _a, _b;
    if (e && app.callbacks.onOpenProject)
      e.preventDefault();
    (_b = (_a = app.callbacks).onSaveProject) == null ? void 0 : _b.call(_a, app);
  }, [app]);
  const onSaveProjectAs = React28.useCallback((e) => {
    var _a, _b;
    if (e && app.callbacks.onOpenProject)
      e.preventDefault();
    (_b = (_a = app.callbacks).onSaveProjectAs) == null ? void 0 : _b.call(_a, app);
  }, [app]);
  const onOpenProject = React28.useCallback((e) => __async(this, null, function* () {
    var _a, _b;
    if (e && app.callbacks.onOpenProject)
      e.preventDefault();
    (_b = (_a = app.callbacks).onOpenProject) == null ? void 0 : _b.call(_a, app);
  }), [app]);
  const onOpenMedia = React28.useCallback((e) => __async(this, null, function* () {
    var _a, _b;
...
function useFileSystem() {
  const promptSaveBeforeChange = React29.useCallback((app) => __async(this, null, function* () {
    if (app.isDirty) {
  ...
  const onNewProject = React29.useCallback((app) => __async(this, null, function* () {
    if (window.confirm("Do you want to create a new project?")) {
      yield promptSaveBeforeChange(app);
      app.newProject();
    }
  }), [promptSaveBeforeChange]);
  const onSaveProject = React29.useCallback((app) => {
    app.saveProject();
  }, []);
  const onSaveProjectAs = React29.useCallback((app) => {
    app.saveProjectAs();
  }, []);
  const onOpenProject = React29.useCallback((app) => __async(this, null, function* () {
    yield promptSaveBeforeChange(app);
    app.openProject();
  }), [promptSaveBeforeChange]);
  const onOpenMedia = React29.useCallback((app) => __async(this, null, function* () {
    var _a;
...
function StatusBar() {
  ...
  return /* @__PURE__ */ React30.createElement(StyledStatusBar, {
    bp: breakpoints,
    id: "TD-StatusBar"
  }, /* @__PURE__ */ React30.createElement(StyledSection, null, activeTool, " | ", status));
}
...
function Kbd({ variant, children }) {
  return /* @__PURE__ */ React31.createElement(StyledKbd, {
    variant
...
// src/components/Primitives/RowButton/RowButton.tsx
var RowButton = React32.forwardRef((_a, ref) => {
  var _b = _a, {
    onClick,
    isActive = false,
    isWarning = false,
  ...
  return /* @__PURE__ */ React32.createElement(StyledRowButton, __spreadValues({
    ref,
    bp: breakpoints,
    isWarning,
    isActive,
    ...
    onClick,
    variant
  }, rest), /* @__PURE__ */ React32.createElement(StyledRowButtonInner, null, children, kbd ? /* @__PURE__ */ React32.createElement(Kbd, {
    variant: "menu"
  }, kbd) : void 0, hasIndicator && /* @__PURE__ */ React32.createElement(import_react_dropdown_menu.ItemIndicator, {
    dir: "ltr"
  }, /* @__PURE__ */ React32.createElement(SmallIcon, null, /* @__PURE__ */ React32.createElement(import_react_icons.CheckIcon, null))), hasArrow && /* @__PURE__ */ React32.createElement(SmallIcon, null, /* @__PURE__ */ React32.createElement(import_react_icons.ChevronRightIcon, null))));
});
...
var BackToContent = React33.memo(function BackToContent2() {
  const app = useTldrawApp();
  const isEmptyCanvas = app.useStore(isEmptyCanvasSelector);
  if (!isEmptyCanvas)
    return null;
  return /* @__PURE__ */ React33.createElement(BackToContentContainer, {
    id: "TD-Tools-Back_to_content"
  }, /* @__PURE__ */ React33.createElement(RowButton, {
...
function Tooltip({ children, label, kbd: kbdProp, id, side = "top" }) {
  return /* @__PURE__ */ React34.createElement("span", {
    id
  }, /* @__PURE__ */ React34.createElement(RadixTooltip.Root, null, /* @__PURE__ */ React34.createElement(RadixTooltip.Trigger, {
    dir: "ltr",
    asChild: true
  }, /* @__PURE__ */ React34.createElement("span", null, children)), /* @__PURE__ */ React34.createElement(StyledContent, {
    dir: "ltr",
    side,
    sideOffset: 8
  }, label, kbdProp ? /* @__PURE__ */ React34.createElement(Kbd, {
    variant: "tooltip"
  }, kbdProp) : null, /* @__PURE__ */ React34.createElement(StyledArrow, null))));
}
...
// src/components/Primitives/ToolButton/ToolButton.tsx
var ToolButton = React35.forwardRef((_a, ref) => {
  var _b = _a, {
    onSelect,
    onClick,
    onDoubleClick,
  ...
  return /* @__PURE__ */ React35.createElement(StyledToolButton, __spreadValues({
    ref,
    isActive,
    isSponsor,
    variant,
    ...
    bp: breakpoints,
    id
  }, rest), /* @__PURE__ */ React35.createElement(StyledToolButtonInner, null, children), isToolLocked && /* @__PURE__ */ React35.createElement(ToolLockIndicator, null));
});
function ToolButtonWithTooltip(_a) {
  ...
  const app = useTldrawApp();
  const handleDoubleClick = React35.useCallback(() => {
    app.toggleToolLock();
  }, []);
  const handleKeyDown = React35.useCallback((e) => {
    if (e.key === " " && app.isForcePanning) {
      e.preventDefault();
    }
  }, []);
  return /* @__PURE__ */ React35.createElement(Tooltip, {
    label: label[0].toUpperCase() + label.slice(1),
    kbd
  }, /* @__PURE__ */ React35.createElement(ToolButton, __spreadProps(__spreadValues({}, rest), {
    variant: "primary",
...
function CircleIcon(props) {
  ...
  return /* @__PURE__ */ React37.createElement("svg", __spreadValues({
    width: 24,
    height: 24
  }, rest), /* @__PURE__ */ React37.createElement("circle", {
    cx: 12,
    cy: 12,
    r: size / 2
  }));
...
function EraserIcon() {
  return /* @__PURE__ */ React49.createElement("svg", {
    ...
    stroke: "currentColor"
  }), /* @__PURE__ */ React49.createElement("line", {
    x1: "6.01807",
    y1: "12.5",
    x2: "10.7959",
    y2: "12.5",
...
var shapeShapeIcons = {
  ["rectangle" /* Rectangle */]: /* @__PURE__ */ React53.createElement(import_react_icons2.SquareIcon, null),
  ["ellipse" /* Ellipse */]: /* @__PURE__ */ React53.createElement(import_react_icons2.CircleIcon, null),
  ["triangle" /* Triangle */]: /* @__PURE__ */ React53.createElement(import_react_icons2.VercelLogoIcon, null),
  ["line" /* Line */]: /* @__PURE__ */ React53.createElement(LineIcon, null)
};
var statusSelector2 = (s) => s.appState.status;
var ShapesMenu = React53.memo(function ShapesMenu2({
  activeTool,
  isToolLocked
}) {
  const app = useTldrawApp();
  ...
  const [lastActiveTool, setLastActiveTool] = React53.useState("rectangle" /* Rectangle */);
  React53.useEffect(() => {
    if (shapeShapes.includes(activeTool) && lastActiveTool !== activeTool) {
      setLastActiveTool(activeTool);
    }
  }, [activeTool]);
  const selectShapeTool = React53.useCallback(() => {
    app.selectTool(lastActiveTool);
  }, [activeTool, app]);
  const handleDoubleClick = React53.useCallback(() => {
    app.toggleToolLock();
  }, [app]);
  const handleKeyDown = React53.useCallback((e) => {
    if (e.key === " ") {
      if (app.shiftKey) {
        e.preventDefault();
      }
  ...
  return /* @__PURE__ */ React53.createElement(DropdownMenu.Root, {
    dir: "ltr",
    onOpenChange: selectShapeTool
  }, /* @__PURE__ */ React53.createElement(DropdownMenu.Trigger, {
    dir: "ltr",
    asChild: true,
    ...
    isActive,
    onKeyDown: handleKeyDown
  }, shapeShapeIcons[lastActiveTool])), /* @__PURE__ */ React53.createElement(DropdownMenu.Content, {
    asChild: true,
    dir: "ltr",
    side: "top",
    sideOffset: 12
  }, /* @__PURE__ */ React53.createElement(Panel, {
    side: "center"
  }, shapeShapes.map((shape, i) => /* @__PURE__ */ React53.createElement(Tooltip, {
    key: shape,
    label: intl.formatMessage({ id: shape[0].toUpperCase() + shape.slice(1) }),
    kbd: (4 + i).toString(),
    id: `TD-PrimaryTools-Shapes-${shape}`
  }, /* @__PURE__ */ React53.createElement(DropdownMenu.Item, {
    asChild: true
  }, /* @__PURE__ */ React53.createElement(ToolButton, {
    variant: "primary",
    onClick: () => {
...
var PrimaryTools = React54.memo(function PrimaryTools2() {
  const app = useTldrawApp();
  const intl = (0, import_react_intl2.useIntl)();
  const activeTool = app.useStore(activeToolSelector2);
  const isToolLocked = app.useStore(toolLockedSelector);
  const selectSelectTool = React54.useCallback(() => {
    app.selectTool("select");
  }, [app]);
  const selectEraseTool = React54.useCallback(() => {
    app.selectTool("erase");
  }, [app]);
  const selectDrawTool = React54.useCallback(() => {
    app.selectTool("draw" /* Draw */);
  }, [app]);
  const selectArrowTool = React54.useCallback(() => {
    app.selectTool("arrow" /* Arrow */);
  }, [app]);
  const selectTextTool = React54.useCallback(() => {
    app.selectTool("text" /* Text */);
  }, [app]);
  const selectStickyTool = React54.useCallback(() => {
    app.selectTool("sticky" /* Sticky */);
  }, [app]);
  return /* @__PURE__ */ React54.createElement(Panel, {
    side: "center",
    id: "TD-PrimaryTools"
  }, /* @__PURE__ */ React54.createElement(ToolButtonWithTooltip, {
    kbd: "1",
    label: intl.formatMessage({ id: "select" }),
    onClick: selectSelectTool,
    isActive: activeTool === "select",
    id: "TD-PrimaryTools-CursorArrow"
  }, /* @__PURE__ */ React54.createElement(import_react_icons3.CursorArrowIcon, null)), /* @__PURE__ */ React54.createElement(ToolButtonWithTooltip, {
    kbd: "2",
    label: intl.formatMessage({ id: "draw" }),
    onClick: selectDrawTool,
    isActive: activeTool === "draw" /* Draw */,
    id: "TD-PrimaryTools-Pencil"
  }, /* @__PURE__ */ React54.createElement(import_react_icons3.Pencil1Icon, null)), /* @__PURE__ */ React54.createElement(ToolButtonWithTooltip, {
    kbd: "3",
    label: intl.formatMessage({ id: "eraser" }),
    onClick: selectEraseTool,
    isActive: activeTool === "erase",
    id: "TD-PrimaryTools-Eraser"
  }, /* @__PURE__ */ React54.createElement(EraserIcon, null)), /* @__PURE__ */ React54.createElement(ShapesMenu, {
    activeTool,
    isToolLocked
  }), /* @__PURE__ */ React54.createElement(ToolButtonWithTooltip, {
    kbd: "8",
  ...
  }, /* @__PURE__ */ React54.createElement(import_react_icons3.ArrowTopRightIcon, null)), /* @__PURE__ */ React54.createElement(ToolButtonWithTooltip, {
    kbd: "9",
  ...
  }, /* @__PURE__ */ React54.createElement(import_react_icons3.TextIcon, null)), /* @__PURE__ */ React54.createElement(ToolButtonWithTooltip, {
    kbd: "0",
    label: intl.formatMessage({ id: "sticky" }),
    onClick: selectStickyTool,
    isActive: activeTool === "sticky" /* Sticky */,
    id: "TD-PrimaryTools-Pencil2"
  }, /* @__PURE__ */ React54.createElement(import_react_icons3.Pencil2Icon, null)));
});
...
function DMItem(_a) {
  ...
  return /* @__PURE__ */ React55.createElement(import_react_dropdown_menu2.Item, {
    dir: "ltr",
    asChild: true,
    onSelect,
    id
  }, /* @__PURE__ */ React55.createElement(RowButton, __spreadValues({}, rest)));
}
...
function DMCheckboxItem({
  ...
  return /* @__PURE__ */ React56.createElement(import_react_dropdown_menu3.CheckboxItem, {
    dir: "ltr",
    ...
    asChild: true,
    id
  }, /* @__PURE__ */ React56.createElement(RowButton, {
    kbd,
    variant,
    hasIndicator: true
  }, children));
...
function DMContent({ sideOffset = 8, children, align, variant, id }) {
  return /* @__PURE__ */ React57.createElement(import_react_dropdown_menu4.Content, {
    dir: "ltr",
    align,
    sideOffset,
    ...
    asChild: true,
    id
  }, /* @__PURE__ */ React57.createElement(StyledContent2, {
    variant
  }, children));
}
...
var DMDivider = styled(import_react_dropdown_menu5.Separator, {
  backgroundColor: "$hover",
  height: 1,
  marginTop: "$2",
  marginRight: "-$2",
...
var DMRadioItem = styled(import_react_dropdown_menu6.RadioItem, {
  height: "32px",
  width: "32px",
  backgroundColor: "$panel",
  borderRadius: "4px",
...
function DMSubMenu({ children, size, disabled = false, label, id }) {
  return /* @__PURE__ */ React58.createElement("span", {
    id
  }, /* @__PURE__ */ React58.createElement(import_react_dropdown_menu7.Root, {
    dir: "ltr"
  }, /* @__PURE__ */ React58.createElement(import_react_dropdown_menu7.TriggerItem, {
    dir: "ltr",
    asChild: true
  }, /* @__PURE__ */ React58.createElement(RowButton, {
    disabled,
    hasArrow: true
  }, label)), /* @__PURE__ */ React58.createElement(import_react_dropdown_menu7.Content, {
    dir: "ltr",
    asChild: true,
    sideOffset: 2,
    alignOffset: -2
  }, /* @__PURE__ */ React58.createElement(MenuContent, {
    size
  }, children, /* @__PURE__ */ React58.createElement(import_react_dropdown_menu7.Arrow, {
    offset: 13
  })))));
}
...
function DMTriggerIcon(_a) {
  ...
  return /* @__PURE__ */ React59.createElement(import_react_dropdown_menu8.Trigger, {
    asChild: true,
    id
  }, /* @__PURE__ */ React59.createElement(ToolButton, __spreadValues({}, rest), children));
}
...
function ActionButton() {
  ...
  const handleRotate = React60.useCallback(() => {
    app.rotate();
  }, [app]);
  const handleDuplicate = React60.useCallback(() => {
    app.duplicate();
  }, [app]);
  const handleToggleLocked = React60.useCallback(() => {
    app.toggleLocked();
  }, [app]);
  const handleToggleAspectRatio = React60.useCallback(() => {
    app.toggleAspectRatioLocked();
  }, [app]);
  const handleGroup = React60.useCallback(() => {
    app.group();
  }, [app]);
  const handleMoveToBack = React60.useCallback(() => {
    app.moveToBack();
  }, [app]);
  const handleMoveBackward = React60.useCallback(() => {
    app.moveBackward();
  }, [app]);
  const handleMoveForward = React60.useCallback(() => {
    app.moveForward();
  }, [app]);
  const handleMoveToFront = React60.useCallback(() => {
    app.moveToFront();
  }, [app]);
  const handleResetAngle = React60.useCallback(() => {
    app.setShapeProps({ rotation: 0 });
  }, [app]);
  const alignTop = React60.useCallback(() => {
    app.align("top" /* Top */);
  }, [app]);
  const alignCenterVertical = React60.useCallback(() => {
    app.align("centerVertical" /* CenterVertical */);
  }, [app]);
  const alignBottom = React60.useCallback(() => {
    app.align("bottom" /* Bottom */);
  }, [app]);
  const stretchVertically = React60.useCallback(() => {
    app.stretch("vertical" /* Vertical */);
  }, [app]);
  const distributeVertically = React60.useCallback(() => {
    app.distribute("vertical" /* Vertical */);
  }, [app]);
  const alignLeft = React60.useCallback(() => {
    app.align("left" /* Left */);
  }, [app]);
  const alignCenterHorizontal = React60.useCallback(() => {
    app.align("centerHorizontal" /* CenterHorizontal */);
  }, [app]);
  const alignRight = React60.useCallback(() => {
    app.align("right" /* Right */);
  }, [app]);
  const stretchHorizontally = React60.useCallback(() => {
    app.stretch("horizontal" /* Horizontal */);
  }, [app]);
  const distributeHorizontally = React60.useCallback(() => {
    app.distribute("horizontal" /* Horizontal */);
  }, [app]);
  const handleMenuOpenChange = React60.useCallback((open4) => {
    app.setMenuOpen(open4);
  }, [app]);
  return /* @__PURE__ */ React60.createElement(DropdownMenu2.Root, {
    dir: "ltr",
    onOpenChange: handleMenuOpenChange
  }, /* @__PURE__ */ React60.createElement(DropdownMenu2.Trigger, {
    dir: "ltr",
    asChild: true,
    id: "TD-Tools-Dots"
  }, /* @__PURE__ */ React60.createElement(ToolButton, {
    variant: "circle"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.DotsHorizontalIcon, null))), /* @__PURE__ */ React60.createElement(DMContent, {
    sideOffset: 16
  }, /* @__PURE__ */ React60.createElement(React60.Fragment, null, /* @__PURE__ */ React60.createElement(ButtonsRow, null, /* @__PURE__ */ React60.createElement(ToolButton, {
    variant: "icon",
    disabled: !hasSelection,
    onClick: handleDuplicate
  }, /* @__PURE__ */ React60.createElement(Tooltip, {
    label: intl.formatMessage({ id: "duplicate" }),
    kbd: `#D`,
    id: "TD-Tools-Copy"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.CopyIcon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
    onClick: handleRotate
  }, /* @__PURE__ */ React60.createElement(Tooltip, {
    label: intl.formatMessage({ id: "rotate" }),
    id: "TD-Tools-Rotate"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.RotateCounterClockwiseIcon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
    ...
    kbd: `#L`,
    id: "TD-Tools-Lock"
  }, isAllLocked ? /* @__PURE__ */ React60.createElement(import_react_icons4.LockClosedIcon, null) : /* @__PURE__ */ React60.createElement(import_react_icons4.LockOpen1Icon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
  ...
  }, isAllAspectLocked ? /* @__PURE__ */ React60.createElement(import_react_icons4.AspectRatioIcon, null) : /* @__PURE__ */ React60.createElement(import_react_icons4.BoxIcon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    ...
    kbd: `#G`,
    id: "TD-Tools-Group"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.GroupIcon, null)))), /* @__PURE__ */ React60.createElement(ButtonsRow, null, /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
  ...
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.PinBottomIcon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
  ...
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.ArrowDownIcon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
    ...
    kbd: `#]`,
    id: "TD-Tools-ArrowUp"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.ArrowUpIcon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
    ...
    kbd: `#\u21E7]`,
    id: "TD-Tools-PinTop"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.PinTopIcon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
    onClick: handleResetAngle
  }, /* @__PURE__ */ React60.createElement(Tooltip, {
    label: intl.formatMessage({ id: "reset.angle" }),
    id: "TD-Tools-ResetAngle"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.AngleIcon, null)))), /* @__PURE__ */ React60.createElement(Divider, null), /* @__PURE__ */ React60.createElement(ButtonsRow, null, /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: alignLeft,
    id: "TD-Tools-AlignLeft"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.AlignLeftIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: alignCenterHorizontal,
    id: "TD-Tools-AlignCenterHorizontal"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.AlignCenterHorizontallyIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: alignRight,
    id: "TD-Tools-AlignRight"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.AlignRightIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: stretchHorizontally,
    id: "TD-Tools-StretchHorizontal"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.StretchHorizontallyIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasThreeOrMore,
    onClick: distributeHorizontally,
    id: "TD-Tools-SpaceEvenlyHorizontal"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.SpaceEvenlyHorizontallyIcon, null))), /* @__PURE__ */ React60.createElement(ButtonsRow, null, /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: alignTop,
    id: "TD-Tools-AlignTop"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.AlignTopIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: alignCenterVertical,
    id: "TD-Tools-AlignCenterVertical"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.AlignCenterVerticallyIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: alignBottom,
    id: "TD-Tools-AlignBottom"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.AlignBottomIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: stretchVertically,
    id: "TD-Tools-tretchVertical"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.StretchVerticallyIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasThreeOrMore,
    onClick: distributeVertically,
    id: "TD-Tools-SpaceEvenlyVertical"
  }, /* @__PURE__ */ React60.createElement(import_react_icons4.SpaceEvenlyVerticallyIcon, null))))));
}
...
function DeleteButton() {
  ...
  const handleDelete = React61.useCallback(() => {
    app.delete();
  }, [app]);
  ...
  return /* @__PURE__ */ React61.createElement(Tooltip, {
  ...
  }, /* @__PURE__ */ React61.createElement(TrashIcon, null)));
}

// src/components/ToolsPanel/ToolsPanel.tsx
var isDebugModeSelector = (s) => s.settings.isDebugMode;
var ToolsPanel = React62.memo(function ToolsPanel2({ onBlur }) {
  const app = useTldrawApp();
  const isDebugMode = app.useStore(isDebugModeSelector);
  return /* @__PURE__ */ React62.createElement(StyledToolsPanelContainer, {
    onBlur
  }, /* @__PURE__ */ React62.createElement(StyledCenterWrap, {
    id: "TD-Tools"
  }, /* @__PURE__ */ React62.createElement(BackToContent, null), /* @__PURE__ */ React62.createElement(StyledPrimaryTools, null, /* @__PURE__ */ React62.createElement(ActionButton, null), /* @__PURE__ */ React62.createElement(PrimaryTools, null), /* @__PURE__ */ React62.createElement(DeleteButton, null))), isDebugMode && /* @__PURE__ */ React62.createElement(StyledStatusWrap, null, /* @__PURE__ */ React62.createElement(StatusBar, null)));
});
...
function PreferencesMenu() {
  ...
  const toggleDebugMode = React63.useCallback(() => {
    app.setSetting("isDebugMode", (v) => !v);
  }, [app]);
  const toggleDarkMode = React63.useCallback(() => {
    app.setSetting("isDarkMode", (v) => !v);
  }, [app]);
  const toggleFocusMode = React63.useCallback(() => {
    app.setSetting("isFocusMode", (v) => !v);
  }, [app]);
  const toggleRotateHandle = React63.useCallback(() => {
    app.setSetting("showRotateHandles", (v) => !v);
  }, [app]);
  const toggleGrid = React63.useCallback(() => {
    app.setSetting("showGrid", (v) => !v);
  }, [app]);
  const toggleBoundShapesHandle = React63.useCallback(() => {
    app.setSetting("showBindingHandles", (v) => !v);
  }, [app]);
  const toggleisSnapping = React63.useCallback(() => {
    app.setSetting("isSnapping", (v) => !v);
  }, [app]);
  const toggleKeepStyleMenuOpen = React63.useCallback(() => {
    app.setSetting("keepStyleMenuOpen", (v) => !v);
  }, [app]);
  const toggleCloneControls = React63.useCallback(() => {
    app.setSetting("showCloneHandles", (v) => !v);
  }, [app]);
  const toggleCadSelectMode = React63.useCallback(() => {
    app.setSetting("isCadSelectMode", (v) => !v);
  }, [app]);
  return /* @__PURE__ */ React63.createElement(DMSubMenu, {
    label: intl.formatMessage({ id: "menu.preferences" }),
    id: "TD-MenuItem-Preferences"
  }, /* @__PURE__ */ React63.createElement(DMCheckboxItem, {
    checked: settings.isDarkMode,
    onCheckedChange: toggleDarkMode,
    kbd: "#\u21E7D",
    id: "TD-MenuItem-Preferences-Dark_Mode"
  }, /* @__PURE__ */ React63.createElement(import_react_intl5.FormattedMessage, {
  ...
  })), /* @__PURE__ */ React63.createElement(DMDivider, null), /* @__PURE__ */ React63.createElement(DMCheckboxItem, {
...
var settingsSelector2 = (s) => s.settings;
function LanguageMenu() {
  const app = useTldrawApp();
  const setting = app.useStore(settingsSelector2);
  ...
  const handleChangeLanguage = React65.useCallback((code) => {
    app.setSetting("language", code);
  }, [app]);
  return /* @__PURE__ */ React65.createElement(DMSubMenu, {
    label: intl.formatMessage({ id: "language" })
  }, languages.map((language4) => /* @__PURE__ */ React65.createElement(DMCheckboxItem, {
    checked: setting.language === language4.code,
    onCheckedChange: () => handleChangeLanguage(language4.code),
    id: `TD-MenuItem-Language-${language4}`
  }, language4.label)));
}
...
var Menu = React66.memo(function Menu2({ sponsor, readOnly }) {
  const app = useTldrawApp();
  ...
  const handleCopyPNG = React66.useCallback(() => {
  ...
  const handleExportPNG = React66.useCallback(() => __async(this, null, function* () {
    app.exportImage("png" /* PNG */, { scale: 2, quality: 1, transparentBackground: true });
  }), [app]);
  const handleExportJPG = React66.useCallback(() => __async(this, null, function* () {
    app.exportImage("jpeg" /* JPG */, { scale: 2, quality: 1, transparentBackground: false });
  }), [app]);
  const handleExportWEBP = React66.useCallback(() => __async(this, null, function* () {
    app.exportImage("webp" /* WEBP */, { scale: 2, quality: 1, transparentBackground: false });
  }), [app]);
  const handleExportSVG = React66.useCallback(() => __async(this, null, function* () {
    app.exportImage("svg" /* SVG */, { scale: 2, quality: 1, transparentBackground: false });
  }), [app]);
  const handleCopyJSON = React66.useCallback(() => __async(this, null, function* () {
    app.copyJson();
  }), [app]);
  ...
  return /* @__PURE__ */ React66.createElement(DropdownMenu3.Root, {
  ...
  }, /* @__PURE__ */ React66.createElement(import_react_intl7.FormattedMessage, {
    id: "new.project"
  })), app.callbacks.onOpenProject && /* @__PURE__ */ React66.createElement(DMItem, {
    onClick: onOpenProject,
    kbd: "#O",
    id: "TD-MenuItem-File-Open"
  }, /* @__PURE__ */ React66.createElement(import_react_intl7.FormattedMessage, {
    id: "open"
  }), "..."), app.callbacks.onSaveProject && /* @__PURE__ */ React66.createElement(DMItem, {
    onClick: onSaveProject,
    kbd: "#S",
    id: "TD-MenuItem-File-Save"
  }, /* @__PURE__ */ React66.createElement(import_react_intl7.FormattedMessage, {
    id: "save"
  })), app.callbacks.onSaveProjectAs && /* @__PURE__ */ React66.createElement(DMItem, {
    onClick: onSaveProjectAs,
    kbd: "#\u21E7S",
    id: "TD-MenuItem-File-Save_As"
  }, /* @__PURE__ */ React66.createElement(import_react_intl7.FormattedMessage, {
    id: "save.as"
  }), "..."), !disableAssets && /* @__PURE__ */ React66.createElement(React66.Fragment, null, /* @__PURE__ */ React66.createElement(Divider, null), /* @__PURE__ */ React66.createElement(DMItem, {
    onClick: handleUploadMedia,
    kbd: "#U",
    id: "TD-MenuItem-File-Upload_Media"
  }, /* @__PURE__ */ React66.createElement(import_react_intl7.FormattedMessage, {
    id: "upload.media"
  })))), /* @__PURE__ */ React66.createElement(DMSubMenu, {
    ...
    id: "redo"
  })), /* @__PURE__ */ React66.createElement(DMDivider, {
    dir: "ltr"
  }), /* @__PURE__ */ React66.createElement(DMItem, {
    onSelect: preventEvent,
  ...
  }, "JSON")), /* @__PURE__ */ React66.createElement(DMSubMenu, {
  ...
  }, "JSON")), /* @__PURE__ */ React66.createElement(DMDivider, {
    dir: "ltr"
  }), /* @__PURE__ */ React66.createElement(DMItem, {
    onSelect: preventEvent,
    ...
    id: "zoom.to"
  }), " 100%"), /* @__PURE__ */ React66.createElement(DMItem, {
    onSelect: preventEvent,
    ...
    dir: "ltr"
  }), /* @__PURE__ */ React66.createElement(LanguageMenu, null), /* @__PURE__ */ React66.createElement(DMDivider, {
    dir: "ltr"
  ...
  }, "Discord", /* @__PURE__ */ React66.createElement(SmallIcon, null, /* @__PURE__ */ React66.createElement(DiscordIcon, null)))), sponsor === false && /* @__PURE__ */ React66.createElement("a", {
    ...
    id: "become.a.sponsor"
  }), " ", /* @__PURE__ */ React66.createElement(SmallIcon, null, /* @__PURE__ */ React66.createElement(HeartIcon, null)))), sponsor === true && /* @__PURE__ */ React66.createElement("a", {
    href: "https://github.com/sponsors/steveruizok",
    target: "_blank",
    rel: "nofollow"
  }, /* @__PURE__ */ React66.createElement(DMItem, {
    id: "TD-MenuItem-is_a_Sponsor"
  }, /* @__PURE__ */ React66.createElement(import_react_intl7.FormattedMessage, {
    id: "sponsored"
  }), "!", /* @__PURE__ */ React66.createElement(SmallIcon, null, /* @__PURE__ */ React66.createElement(import_react_icons5.HeartFilledIcon, null)))), showSignInOutMenu && /* @__PURE__ */ React66.createElement(React66.Fragment, null, /* @__PURE__ */ React66.createElement(DMDivider, {
    dir: "ltr"
    ...
    id: "menu.sign.in"
  })), app.callbacks.onSignOut && /* @__PURE__ */ React66.createElement(DMItem, {
    onSelect: handleSignOut,
    id: "TD-MenuItem-Sign_out"
  }, /* @__PURE__ */ React66.createElement(import_react_intl7.FormattedMessage, {
    id: "menu.sign.out"
  }), /* @__PURE__ */ React66.createElement(SmallIcon, null, /* @__PURE__ */ React66.createElement(import_react_icons5.ExitIcon, null))))));
});
...
function PageOptionsDialog({ page, onOpen, onClose }) {
  ...
  }, /* @__PURE__ */ React68.createElement(import_react_intl8.FormattedMessage, {
    id: "duplicate"
  })), /* @__PURE__ */ React68.createElement(DialogAction, {
    disabled: !canDelete,
    onSelect: handleDelete
  }, /* @__PURE__ */ React68.createElement(import_react_intl8.FormattedMessage, {
    id: "delete"
  })), /* @__PURE__ */ React68.createElement(Divider, null), /* @__PURE__ */ React68.createElement(Dialog.Cancel, {
    asChild: true
  }, /* @__PURE__ */ React68.createElement(RowButton, null, /* @__PURE__ */ React68.createElement(import_react_intl8.FormattedMessage, {
    id: "cancel"
  }))))));
}
...
function PageMenuContent({ onClose }) {
  ...
  return /* @__PURE__ */ React69.createElement(React69.Fragment, null, /* @__PURE__ */ React69.createElement(DropdownMenu4.RadioGroup, {
    ...
    asChild: true
  }, /* @__PURE__ */ React69.createElement(RowButton, null, /* @__PURE__ */ React69.createElement("span", null, /* @__PURE__ */ React69.createElement(import_react_intl9.FormattedMessage, {
    id: "create.page"
  })), /* @__PURE__ */ React69.createElement(SmallIcon, null, /* @__PURE__ */ React69.createElement(import_react_icons7.PlusIcon, null)))));
}
...
var ZoomMenu = React70.memo(function ZoomMenu2() {
  ...
  return /* @__PURE__ */ React70.createElement(DropdownMenu5.Root, {
    ...
    kbd: "#+",
    id: "TD-Zoom-Zoom_In"
  }, /* @__PURE__ */ React70.createElement(import_react_intl10.FormattedMessage, {
    id: "zoom.in"
  })), /* @__PURE__ */ React70.createElement(DMItem, {
    onSelect: preventEvent,
    onClick: app.zoomOut,
...
var StyleMenu = React71.memo(function ColorMenu() {
  ...
  const handleToggleKeepOpen = React71.useCallback((checked) => {
  ...
  const handleMenuOpenChange = React71.useCallback((open4) => {
    app.setMenuOpen(open4);
  }, [app]);
  return /* @__PURE__ */ React71.createElement(DropdownMenu6.Root, {
    ...
    variant: "text"
  }, /* @__PURE__ */ React71.createElement(import_react_intl11.FormattedMessage, {
    id: "styles"
  }), /* @__PURE__ */ React71.createElement(OverlapIcons, {
    style: {
  ...
  }, /* @__PURE__ */ React71.createElement("span", null, /* @__PURE__ */ React71.createElement(import_react_intl11.FormattedMessage, {
    id: "style.menu.color"
  })), /* @__PURE__ */ React71.createElement(ColorGrid, null, Object.keys(strokes.light).map((style) => /* @__PURE__ */ React71.createElement(DropdownMenu6.Item, {
    key: style,
    onSelect: preventEvent,
    asChild: true,
    ...
    id: "style.menu.fill"
  })), /* @__PURE__ */ React71.createElement(StyledRow, {
    id: "TD-Styles-Dash-Container"
  }, /* @__PURE__ */ React71.createElement(import_react_intl11.FormattedMessage, {
    id: "style.menu.dash"
  }), /* @__PURE__ */ React71.createElement(StyledGroup, {
    dir: "ltr",
  ...
  }, ALIGN_ICONS[style]))))), /* @__PURE__ */ React71.createElement(DMDivider, null), /* @__PURE__ */ React71.createElement(DMCheckboxItem, {
    variant: "styleMenu",
    checked: keepOpen,
...
var MultiplayerMenu = React72.memo(function MultiplayerMenu2() {
  ...
  const handleCreateMultiplayerProject = React72.useCallback(() => __async(this, null, function* () {
    if (app.isDirty) {
      if (app.fileSystemHandle) {
        if (window.confirm("Do you want to save changes to your current project?")) {
          yield app.saveProject();
  ...
  const handleCopyToMultiplayerProject = React72.useCallback(() => __async(this, null, function* () {
    var _a;
    const nextDocument = __spreadValues({}, app.document);
    ...
    try {
      if (app.callbacks.onAssetUpload) {
        for (const id in nextDocument.assets) {
          ...
          if (asset.src.includes("base64")) {
            const file = dataURLtoFile(asset.src, ((_a = asset.fileName) != null ? _a : asset.type === "video" /* Video */) ? "image.png" : "image.mp4");
      ...
      const result = yield fetch(`/api/create`, {
        ...
        body: JSON.stringify({
          roomId: import_core55.Utils.uniqueId(),
  ...
  return /* @__PURE__ */ React72.createElement(DropdownMenu7.Root, {
    ...
    disabled: !room
  }, /* @__PURE__ */ React72.createElement(import_react_intl12.FormattedMessage, {
    id: "copy.invite.link"
  }), /* @__PURE__ */ React72.createElement(SmallIcon, null, copied ? /* @__PURE__ */ React72.createElement(import_react_icons9.CheckIcon, null) : /* @__PURE__ */ React72.createElement(import_react_icons9.ClipboardIcon, null))), /* @__PURE__ */ React72.createElement(DMDivider, {
...
function TopPanel({
  ...
  return /* @__PURE__ */ React73.createElement(StyledTopPanel, null, (showMenu || showPages) && /* @__PURE__ */ React73.createElement(Panel, {
    ...
    side: "right"
  }, /* @__PURE__ */ React73.createElement(ToolButton, null, /* @__PURE__ */ React73.createElement(UndoIcon, {
    onClick: app.undo
  })), /* @__PURE__ */ React73.createElement(ToolButton, null, /* @__PURE__ */ React73.createElement(RedoIcon, {
    onClick: app.redo
  })), showZoom && /* @__PURE__ */ React73.createElement(ZoomMenu, null), showStyles && !readOnly && /* @__PURE__ */ React73.createElement(StyleMenu, null)));
}
...
var InnerMenu = React74.memo(function InnerMenu2({ onBlur }) {
  ...
  const handleCopyPNG = React74.useCallback(() => {
    app.copyImage("png" /* PNG */, { scale: 2, quality: 1, transparentBackground: true });
  }, [app]);
  ...
  const handleExportSVG = React74.useCallback(() => __async(this, null, function* () {
    app.exportImage("svg" /* SVG */, { scale: 1, quality: 1, transparentBackground: false });
  }), [app]);
  const handleCopyJSON = React74.useCallback(() => __async(this, null, function* () {
    app.copyJson();
  }), [app]);
  ...
  return /* @__PURE__ */ React74.createElement(RadixContextMenu.Content, {
  ...
  }, /* @__PURE__ */ React74.createElement(import_react_intl13.FormattedMessage, {
    id: "duplicate"
    ...
    id: "unlock"
  })), (hasTwoOrMore || hasGroupSelected) && /* @__PURE__ */ React74.createElement(Divider, null), hasTwoOrMore && /* @__PURE__ */ React74.createElement(CMRowButton, {
    onClick: handleGroup,
    kbd: "#G",
    id: "TD-ContextMenu-Group"
  }, /* @__PURE__ */ React74.createElement(import_react_intl13.FormattedMessage, {
    id: "group"
  })), hasGroupSelected && /* @__PURE__ */ React74.createElement(CMRowButton, {
    onClick: handleGroup,
    kbd: "#G",
    ...
    id: "ungroup"
  })), /* @__PURE__ */ React74.createElement(Divider, null), /* @__PURE__ */ React74.createElement(ContextMenuSubMenu, {
    ...
    id: "back"
  }))), /* @__PURE__ */ React74.createElement(MoveToPageMenu, null), hasTwoOrMore && /* @__PURE__ */ React74.createElement(AlignDistributeSubMenu, {
    hasTwoOrMore,
    hasThreeOrMore
  }), /* @__PURE__ */ React74.createElement(Divider, null), /* @__PURE__ */ React74.createElement(CMRowButton, {
    onClick: handleCut,
    kbd: "#X",
  ...
  }, "PNG"), isDebugMode && /* @__PURE__ */ React74.createElement(CMRowButton, {
    onClick: handleCopyJSON,
    id: "TD-ContextMenu-Copy_as_JSON"
  }, "JSON")), /* @__PURE__ */ React74.createElement(ContextMenuSubMenu, {
    label: `${intl.formatMessage({ id: "export.as" })}...`,
    size: "small",
  ...
  }, "WEBP"), isDebugMode && /* @__PURE__ */ React74.createElement(CMRowButton, {
    onClick: handleExportJSON,
    ...
    id: "delete"
  }))) : /* @__PURE__ */ React74.createElement(React74.Fragment, null, /* @__PURE__ */ React74.createElement(CMRowButton, {
    onClick: handlePaste,
    kbd: "#V",
    id: "TD-ContextMenu-Paste"
  }, /* @__PURE__ */ React74.createElement(import_react_intl13.FormattedMessage, {
...
function MoveToPageMenu() {
  ...
  return /* @__PURE__ */ React74.createElement(RadixContextMenu.Root, {
    ...
    id: "move.to.page"
  })), /* @__PURE__ */ React74.createElement(RadixContextMenu.Content, {
    dir: "ltr",
    sideOffset: 2,
    alignOffset: -2,
    asChild: true
...
function ErrorFallback({ error, resetErrorBoundary }) {
  ...
  return /* @__PURE__ */ React77.createElement(Container, null, /* @__PURE__ */ React77.createElement(InnerContainer, null, /* @__PURE__ */ React77.createElement("div", null, "We've encountered an error!"), /* @__PURE__ */ React77.createElement("pre", null, /* @__PURE__ */ React77.createElement("code", null, error.message)), /* @__PURE__ */ React77.createElement(Buttons, null, /* @__PURE__ */ React77.createElement(RowButton, {
    onClick: copyError
  }, "Copy Error"), /* @__PURE__ */ React77.createElement(RowButton, {
    onClick: refreshPage
  }, "Refresh Page")), /* @__PURE__ */ React77.createElement(Divider, null), /* @__PURE__ */ React77.createElement("p", null, "Keep getting this error?", " ", /* @__PURE__ */ React77.createElement("a", {
    onClick: downloadBackup,
    title: "Download your project"
  }, "Download your project"), " ", "as a backup and then", " ", /* @__PURE__ */ React77.createElement("a", {
...
var style_menu_color = "Color";
var style_menu_fill = "Fill";
var style_menu_dash = "Dash";
var style_menu_size = "Size";
var style_menu_keep_open = "Keep open";
var style_menu_font = "Font";
var style_menu_align = "Align";
var styles2 = "Styles";
var zoom_in = "Zoom in";
var zoom_out = "Zoom out";
var to = "to";
var to_selection = "To selection";
var to_fit = "To fit";
var menu_file = "File";
var menu_edit = "Edit";
var menu_view = "View";
var menu_preferences = "Preferences";
var menu_sign_in = "Sign In";
var menu_sign_out = "Sign Out";
var sponsored = "Sponsored";
var become_a_sponsor = "Become a sponsor";
var zoom_to_selection = "Zoom to Selection";
var zoom_to_fit = "Zoom to Fit";
var zoom_to = "Zoom to";
var preferences_dark_mode = "Dark Mode";
var preferences_focus_mode = "Focus Mode";
var preferences_debug_mode = "Debug Mode";
var preferences_show_grid = "Show Grid";
var preferences_use_cad_selection = "Use CAD Selection";
var preferences_keep_stylemenu_open = "Keep Style Menu Open";
var preferences_always_show_snaps = "Always Show Snaps";
var preferences_rotate_handles = "Rotate Handles";
var preferences_binding_handles = "Binding Handles";
var preferences_clone_handles = "Clone Handles";
var undo = "Undo";
var redo = "Redo";
var cut = "Cut";
var copy = "Copy";
...
var save = "Save";
var save_as = "Save As";
var upload_media = "Upload Media";
var create_page = "Create Page";
var new_page = "New Page";
var page_name = "Page Name";
var duplicate = "Duplicate";
var cancel = "Cancel";
var copy_invite_link = "Copy Invite Link";
var create_multiplayer_project = "Create a Multiplayer Project";
var copy_multiplayer_project = "Copy to Multiplayer Project";
var select = "Select";
var eraser = "Eraser";
var draw = "Draw";
var arrow = "Arrow";
...
var Line = "Line";
var rotate = "Rotate";
var lock_aspect_ratio = "Lock Aspect Ratio";
var unlock_aspect_ratio = "Unlock Aspect Ratio";
var group = "Group";
var ungroup = "Ungroup";
var move_to_back = "Move to Back";
var move_backward = "Move Backward";
var move_forward = "Move Forward";
var move_to_front = "Move to Front";
var reset_angle = "Reset Angle";
var lock = "Lock";
var unlock = "Unlock";
var move_to_page = "Move to Page";
var flip_horizontal = "Flip Horizontal";
var flip_vertical = "Flip Vertical";
var move = "Move";
var to_front = "To Front";
var forward = "Forward";
...
var style_menu_color2 = "Couleur";
var style_menu_fill2 = "Remplir";
var style_menu_dash2 = "Bordure";
var style_menu_size2 = "Taille";
var style_menu_keep_open2 = "Garder ouvert";
var style_menu_font2 = "Font";
var style_menu_align2 = "Alignement";
var styles3 = "Styles";
var zoom_in2 = "Zoomer";
var zoom_out2 = "D\xE9zoomer";
var to2 = "\xC0";
var to_selection2 = "S\xE9lection";
var to_fit2 = "Adapter";
var menu_file2 = "Fichier";
var menu_edit2 = "Modifier";
var menu_view2 = "Vue";
var menu_preferences2 = "Pr\xE9f\xE9rences";
var menu_sign_in2 = "S'authentifier";
var menu_sign_out2 = "Se d\xE9connecter";
var sponsored2 = "Sponsoris\xE9";
var become_a_sponsor2 = "Devenir un sponsor";
var zoom_to_selection2 = "Zoomer sur la s\xE9lection";
var zoom_to_fit2 = "Zoomer pour adapter";
var zoom_to2 = "R\xE9initialiser le zoom \xE0";
var preferences_dark_mode2 = "Mode Sombre";
var preferences_focus_mode2 = "Mode Focus";
var preferences_debug_mode2 = "D\xE9bogage Mode";
var preferences_show_grid2 = "Montrer La Grille";
var preferences_use_cad_selection2 = "Utiliser La S\xE9lection CAD";
var preferences_keep_stylemenu_open2 = "Garder Le Menu Style Ouvert";
var preferences_always_show_snaps2 = "Garder Les Snaps Visible";
var preferences_rotate_handles2 = "Manipuler La Rotation";
var preferences_binding_handles2 = "Manipuler La Liaison";
var preferences_clone_handles2 = "Manipuler Le Clonage";
var undo2 = "Annuler";
var redo2 = "Refaire";
var cut2 = "Couper";
var copy2 = "Copier";
var paste2 = "Coller";
var copy_as2 = "Copier en tant que";
var export_as2 = "Exporter en tant que";
var select_all2 = "S\xE9lectionner tout";
var select_none2 = "S\xE9lectionner aucun";
var delete3 = "Supprimer";
var new_project2 = "Nouveau Project";
var open2 = "Ouvrir";
var save2 = "Enregistrer";
var save_as2 = "Enregistrer en tant que";
var upload_media2 = "Uploader Un M\xE9dia";
var create_page2 = "Cr\xE9er une Page";
var new_page2 = "Nouvelle Page";
var page_name2 = "Nom de la Page";
var duplicate2 = "Dupliquer";
var cancel2 = "Annuler";
var copy_invite_link2 = "Copier le Lien d'Invitation";
var create_multiplayer_project2 = "Cr\xE9er un Project Multi-joueurs";
var copy_multiplayer_project2 = "Copier dans un Projet Multi-joueurs";
var select2 = "Selection";
var eraser2 = "Gomme";
var draw2 = "Crayon";
var arrow2 = "Fl\xE8che";
var text2 = "Text";
var sticky2 = "Papier collant";
var Rectangle3 = "Rectangle";
var Ellipse3 = "Cercle";
var Triangle3 = "Triangle";
var Line2 = "Ligne";
var rotate2 = "Retourner";
var lock_aspect_ratio2 = "Verouiller l'Aspect Ratio";
var unlock_aspect_ratio2 = "D\xE9verouiller l'Aspect Ratio";
var group2 = "Grouper";
var ungroup2 = "D\xE9grouper";
var move_to_back2 = "Envoyer vers l'arri\xE8re";
var move_backward2 = "Mettre en arri\xE8re-plan";
var move_forward2 = "Mettre au premier plan";
var move_to_front2 = "Envoyer vers l'avant";
var reset_angle2 = "R\xE9initialiser l'Angle";
var lock2 = "Verouiller";
var unlock2 = "D\xE9verouiller";
var move_to_page2 = "D\xE9placer vers la page";
var flip_horizontal2 = "Retourner Horizontalement";
var flip_vertical2 = "Retourner Verticalement";
var move2 = "Mettre";
var to_front2 = "\xC0 l'avant";
var forward2 = "Au premier plan";
var backward2 = "En arri\xE8re plan";
var back2 = "\xC0 l'arri\xE8re";
var language2 = "Langage";
var fr_default = {
...
var style_menu_color3 = "Colore";
var style_menu_fill3 = "Riempi";
var style_menu_dash3 = "Tratteggo";
var style_menu_size3 = "Dimensione";
var style_menu_keep_open3 = "Mantieni aperto";
var style_menu_font3 = "Font";
var style_menu_align3 = "Allineamento";
var styles4 = "Stile";
var zoom_in3 = "Ingrandisci";
var zoom_out3 = "Rimpicciolisci";
var to3 = "Imposta";
var to_selection3 = "Adatta alla selezione";
var to_fit3 = "Adatta";
var menu_file3 = "File";
var menu_edit3 = "Modifica";
var menu_view3 = "Visualizzazione";
var menu_preferences3 = "Preferenze";
var menu_sign_in3 = "Accedi";
var menu_sign_out3 = "Esci";
var sponsored3 = "Sponsorizza";
var become_a_sponsor3 = "Sponsorizza";
var zoom_to_selection3 = "Adatta alla selezione";
var zoom_to_fit3 = "Adatta";
var zoom_to3 = "Ingrandisci";
var preferences_dark_mode3 = "Modalit\xE0 scura";
var preferences_focus_mode3 = "Modalit\xE0 zen";
var preferences_debug_mode3 = "Modalit\xE0 sviluppatore";
var preferences_show_grid3 = "Mostra griglia";
var preferences_use_cad_selection3 = "Selezione CAD";
var preferences_keep_stylemenu_open3 = "Mantieni menu stile aperto";
var preferences_always_show_snaps3 = "Mostra sempre le guide";
var preferences_rotate_handles3 = "Controlli d'inclinazione";
var preferences_binding_handles3 = "Controlli d'associazione";
var preferences_clone_handles3 = "Controlli di clonazione";
var undo3 = "Annulla";
var redo3 = "Ripristina";
var cut3 = "Taglia";
var copy3 = "Copia";
var paste3 = "Incolla";
var copy_as3 = "Copia come";
var export_as3 = "Esporta come";
var select_all3 = "Seleziona tutto";
var select_none3 = "Deseleziona tutto";
var delete4 = "Elimina";
var new_project3 = "Nuovo progetto";
var open3 = "Apri";
var save3 = "Salva";
var save_as3 = "Salva come";
var upload_media3 = "Carica contenuti multimediali";
var create_page3 = "Crea nuova pagina";
var new_page3 = "Nuova pagina";
var page_name3 = "Nome pagina";
var duplicate3 = "Duplica";
var cancel3 = "Chiudi";
var copy_invite_link3 = "Copia link invito";
var create_multiplayer_project3 = "Crea progetto multiplayer";
var copy_multiplayer_project3 = "Trasforma in progetto multiplayer";
var select3 = "Seleziona";
var eraser3 = "Gomma";
var draw3 = "Matita";
var arrow3 = "Freccia";
var text3 = "Casella di testo";
var sticky3 = "Post-it";
var Rectangle4 = "Rettangolo";
var Ellipse4 = "Ellisse";
var Triangle4 = "Triangolo";
var Line3 = "Linea";
var rotate3 = "Ruota";
var lock_aspect_ratio3 = "Blocca rapporto lati";
var unlock_aspect_ratio3 = "Sblocca rapporto lati";
var group3 = "Raggruppa";
var move_to_back3 = "Muovi in fondo";
var move_backward3 = "Sposta indietro";
var move_forward3 = "Sposta avanti";
var move_to_front3 = "Muovi in fronte";
var reset_angle3 = "Reimposta angolo";
var lock3 = "Blocca";
var unlock3 = "Sblocca";
var move_to_page3 = "Trasferisci a pagina";
var flip_horizontal3 = "Ribalta orizzontalmente";
var flip_vertical3 = "Ribalta verticalmente";
var move3 = "Sposta";
var to_front3 = "In primo piano";
var forward3 = "Sposta avanti";
var backward3 = "Sposta indietro";
var back3 = "In fondo";
var language3 = "Lingua";
var it_default = {
...
function Tldraw({
  ...
  const [sId, setSId] = React78.useState(id);
  const [app, setApp] = React78.useState(() => {
  ...
  return /* @__PURE__ */ React78.createElement(TldrawContext.Provider, {
    value: app
  }, /* @__PURE__ */ React78.createElement(InnerTldraw, {
    key: sId || "Tldraw",
    id: sId,
    autofocus,
    showPages,
...
var InnerTldraw = React78.memo(function InnerTldraw2({
  id,
  autofocus,
  showPages,
  showMenu,
  ...
  var _a, _b, _c;
  const app = useTldrawApp();
  const rWrapper = React78.useRef(null);
  ...
  const defaultLanguage = (_b = settings.language) != null ? _b : navigator.language.split(/[-_]/)[0];
  return /* @__PURE__ */ React78.createElement(import_react_intl14.IntlProvider, {
    locale: defaultLanguage,
    messages: messages[defaultLanguage]
  }, /* @__PURE__ */ React78.createElement(StyledLayout, {
    ref: rWrapper,
    tabIndex: -0,
    className: settings.isDarkMode ? dark : ""
  }, /* @__PURE__ */ React78.createElement(Loading, null), /* @__PURE__ */ React78.createElement(OneOff, {
    focusableRef: rWrapper,
    autofocus
  }), /* @__PURE__ */ React78.createElement(ContextMenu, null, /* @__PURE__ */ React78.createElement(ErrorBoundary, {
    FallbackComponent: ErrorFallback
  }, /* @__PURE__ */ React78.createElement(import_core56.Renderer, {
    id,
    ...
    showDashedBrush,
    performanceMode: (_c = app.session) == null ? void 0 : _c.performanceMode,
    ...
    onDrop: app.onDrop
  }))), showUI && /* @__PURE__ */ React78.createElement(StyledUI, null, settings.isFocusMode ? /* @__PURE__ */ React78.createElement(FocusButton, {
    onSelect: app.toggleFocusMode
  }) : /* @__PURE__ */ React78.createElement(React78.Fragment, null, /* @__PURE__ */ React78.createElement(TopPanel, {
    readOnly,
    showPages,
    showMenu,
    showMultiplayerMenu,
  ...
  }), /* @__PURE__ */ React78.createElement(StyledSpacer2, null), showTools && !readOnly && /* @__PURE__ */ React78.createElement(ToolsPanel, null)))));
});
var OneOff = React78.memo(function OneOff2({
  focusableRef,
  autofocus
}) {
