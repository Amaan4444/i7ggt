// idb-keyval React @tldraw/tldraw @stitches import intersect idbfr2 SvgCont
...
import { FormattedMessage as FormattedMessage8, useIntl as useIntl9 } from "react-intl";
...
import { Utils as Utils55 } from "../../../@tldraw/core";
...
import { FormattedMessage as FormattedMessage3, useIntl as useIntl8 } from "react-intl";
...
import { FormattedMessage as FormattedMessage2, useIntl as useIntl7 } from "react-intl";
...
import { FormattedMessage, useIntl as useIntl5 } from "react-intl";
...
import { Root as Root3, TriggerItem, Content as Content4, Arrow as Arrow3 } from "@radix-ui/react-dropdown-menu";
...
import * as idbfr  from "idb-keyval";
...
import * as React20 from "react";import * as React24 from "react";
...
import { intersectBoundsBounds ,intersectBoundsPolyline, intersectLineSegmentLineSegment as intersectLineSegmentLineSegment2, intersectLineSegmentBounds as intersectLineSegmentBounds3 } from "../../../@tldraw/intersect";
...
import { Vec as Vec14 } from "../../../@tldraw/vec";import * as React21 from "react";
...
import {  SVGContainer as SVGContainer6 } from "../../../@tldraw/core";
...
import * as idbfr2 from "idb-keyval";
...
var { get: getFromIdb, set: setToIdb } = idbfr2
//import Object.fromEntries

const fromEntriesMod = !Object.fromEntries ? (data)=>{
  var objNew = {}
  for(var i in data){
objNew[data[i][0]] = data[i][1]
  }
  return objNew
...
var init_file_save = __esm({
  "src/state/data/browser-fs-access/legacy/file-save.js"() {
    file_save_default = (_0, ..._1) => __async(void 0, [_0, ..._1], function* (blobOrResponse, options2 = {}) {
      ...
      const _reject = (reject) => cleanupListenersAndMaybeReject(reject);
      const _resolve = () => {
        if (typeof cleanupListenersAndMaybeReject === "function") {
          cleanupListenersAndMaybeReject();
        }
...
var init_file_save2 = __esm({
  "src/state/data/browser-fs-access/fs-access/file-save.js"() {
    file_save_default2 = (_0, ..._1) => __async(void 0, [_0, ..._1], function* (blobOrResponse, options2 = [{}], existingHandle = null, throwIfExistingHandleNotGood = false) {
      ...
      yield writable.write(blobOrResponse);
...
var stickyFills = {
  light: __spreadProps(__spreadValues({}, fromEntriesMod(Object.entries(colors).map(([k, v]) => [k, Utils.lerpColor(v, canvasLight, 0.45)]))), {
    ["white" /* White */]: "#ffffff",
    ["black" /* Black */]: "#3d3d3d"
  }),
...
var strokes = {
  ...
  dark: __spreadProps(__spreadValues({}, fromEntriesMod(Object.entries(colors).map(([k, v]) => [k, Utils.lerpColor(v, canvasDark, 0.1)]))), {
    ["white" /* White */]: "#cecece",
    ["black" /* Black */]: "#cecece"
  })
};
var fills = {
  light: __spreadProps(__spreadValues({}, fromEntriesMod(Object.entries(colors).map(([k, v]) => [k, Utils.lerpColor(v, canvasLight, 0.82)]))), {
    ["white" /* White */]: "#fefefe"
  }),
  dark: __spreadProps(__spreadValues({}, fromEntriesMod(Object.entries(colors).map(([k, v]) => [k, Utils.lerpColor(v, canvasDark, 0.82)]))), {
...
// src/state/shapes/RectangleUtil/components/DashedRectangle.tsxx
...
var RectangleUtil = class extends TDShapeUtil {
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({
      ...
      }), /* @__PURE__ */ React6.createElement(SVGContainer, {
        id: shape.id + "_svg",
  ...
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({
      ...
      return /* @__PURE__ */ React10.createElement(FullWrapper2, __spreadValues({
        ...
        onChange: handleLabelChange,
        onBlur: onShapeBlur
      }), /* @__PURE__ */ React10.createElement(SVGContainer2, {
        id: shape.id + "_svg",
        opacity: isGhost ? GHOSTED_OPACITY : 1
  ...
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({
      ...
      return /* @__PURE__ */ React13.createElement(FullWrapper3, __spreadValues({
        ...
        offsetX: (labelPoint[0] - 0.5) * bounds.width,
        offsetY: (labelPoint[1] - 0.5) * bounds.height
      }), /* @__PURE__ */ React13.createElement(SVGContainer3, {
        id: shape.id + "_svg",
        opacity: isGhost ? GHOSTED_OPACITY : 1
  ...
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({ shape, isEditing, isGhost, meta, events, onShapeChange, onShapeBlur }, ref) => {
      ...
      return /* @__PURE__ */ React18.createElement(FullWrapper4, __spreadValues({
        ...
        onChange: handleLabelChange,
        onBlur: onShapeBlur
      }), /* @__PURE__ */ React18.createElement(SVGContainer4, {
        id: shape.id + "_svg"
...
var GroupUtil = class extends TDShapeUtil {
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({ shape, isBinding, isGhost, isHovered, isSelected, events }, ref) => {
      ...
      return /* @__PURE__ */ React19.createElement(SVGContainer5, __spreadValues({
        ref
...
var StickyUtil = class extends TDShapeUtil {
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({ shape, meta, events, isGhost, isBinding, isEditing, onShapeBlur, onShapeChange }, ref) => {
      ...
      return /* @__PURE__ */ React20.createElement(HTMLContainer, __spreadValues({
        ref
...
var TextUtil = class extends TDShapeUtil {
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({ shape, isBinding, isGhost, isEditing, onShapeBlur, onShapeChange, meta, events }, ref) => {
      ...
      return /* @__PURE__ */ React21.createElement(HTMLContainer2, __spreadValues({
        ref
  ...
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({ shape, meta, isSelected, isGhost, events }, ref) => {
      ...
      if (verySmall) {
        ...
        return /* @__PURE__ */ React22.createElement(SVGContainer6, __spreadValues({
          ref,
          id: shape.id + "_svg"
    ...
    __publicField(this, "hitTestLineSegment", (shape, A, B) => {
      ...
      if (bounds.width < 8 && bounds.height < 8) {
        return Vec17.distanceToLineSegment(A, B, Utils21.getBoundsCenter(bounds)) < 5;
      }
...
var ImageUtil = class extends TDShapeUtil {
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({ shape, asset = { src: "" }, isBinding, isGhost, meta, events, onShapeChange }, ref) => {
      ...
      return /* @__PURE__ */ React23.createElement(HTMLContainer3, __spreadValues({
        ref
...
var VideoUtil = class extends TDShapeUtil {
  constructor() {
    ...
    __publicField(this, "Component", TDShapeUtil.Component(({ shape, asset = { src: "" }, isBinding, isEditing, isGhost, meta, events, onShapeChange }, ref) => {
      ...
      return /* @__PURE__ */ React24.createElement(HTMLContainer4, __spreadValues({
        ref
          ...
          switch (A.target.type) {
            ...
            default: {
              ...
              if (B.isBound && (hits.length < 2 || bHit && hits[0] && Math.ceil(Vec18.dist(hits[0], bHit)) < BINDING_DISTANCE * 2.5 || Utils24.boundsContain(A.expandedBounds, B.expandedBounds) || Utils24.boundsCollide(A.expandedBounds, B.expandedBounds))) {
                ...
                result[ID2 === "start" ? "end" : "start"].point = Vec18.toFixed(Vec18.add(Vec18.sub(shortArrowHits[0], arrowShape.point), Vec18.mul(shortArrowDirection, Math.min(Vec18.dist(shortArrowHits[0], B.point), BINDING_DISTANCE * 2.5 * (Utils24.boundsContain(B.bounds, A.intersectBounds) ? -1 : 1)))));
...
var EraseSession = class extends BaseSession {
  constructor(app) {
    ...
    __publicField(this, "update", () => {
      ...
      if (shiftKey) {
        if (!this.isLocked && Vec32.dist(originPoint, currentPoint) > 4 / zoom) {
          if (!this.lockedDirection) {
...
var StateManager = class {
  constructor(initialState, id, version, update) {
    ...
    __publicField(this, "persist", (id) => {
      ...
      if (this._idbId) {
        return set3(this._idbId, this._state).catch((e) => console.error(e));
      }
    });
    ...
    this.ready = new Promise((resolve) => {
      ...
      if (this._idbId) {
        message = "restored";
        get3(this._idbId).then((saved) => __async(this, null, function* () {
          if (saved) {
            let next = saved;
            if (version) {
            ...
            yield set3(id + "_version", version || -1);
...
var { get: get2, set: set2, del } = idbfr
  ...
  constructor(id, callbacks = {}) {
    ...
    __publicField(this, "cleanup", (state, prev) => {
      ...
      Object.keys((_a = next.document.assets) != null ? _a : {}).forEach((id) => {
        var _a2, _b;
        _a2 = next.document.assets
        if (!(_a2 == null ? void 0 : _a2[id])) {
          _b = next.document.assets;
          _b  == null ? console.log('ok') : delete _b[id];
        }
      });
    ...
    __publicField(this, "zoomToContent", () => {
      ...
      const mx = (rendererBounds.width - commonBounds.width * zoom) / 2 / zoom;
      const my = (rendererBounds.height - commonBounds.height * zoom) / 2 / zoom;
      return this.setCamera(Vec43.toFixed(Vec43.sub([mx, my], [commonBounds.minX, commonBounds.minY])), this.camera.zoom, `zoomed_to_content`);
    });
    ...
    __publicField(this, "onPan", (info, e) => {
      if (this.appState.status === "pinching")
        return;
      const delta = Vec43.div(info.delta, this.camera.zoom);
...
var RowButton = React32.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React32.createElement(StyledRowButton, __spreadValues({
    ...
    variant: "menu"
  }, kbd) : void 0, hasIndicator && /* @__PURE__ */ React32.createElement(ItemIndicator, {
    dir: "ltr"
  }, /* @__PURE__ */ React32.createElement(SmallIcon, null, /* @__PURE__ */ React32.createElement(CheckIcon, null))), hasArrow && /* @__PURE__ */ React32.createElement(SmallIcon, null, /* @__PURE__ */ React32.createElement(ChevronRightIcon, null))));
});
...
var shapeShapeIcons = {
  ["rectangle" /* Rectangle */]: /* @__PURE__ */ React53.createElement(SquareIcon, null),
  ["ellipse" /* Ellipse */]: /* @__PURE__ */ React53.createElement(CircleIcon2, null),
  ["triangle" /* Triangle */]: /* @__PURE__ */ React53.createElement(VercelLogoIcon, null),
...
var PrimaryTools = React54.memo(function PrimaryTools2() {
  ...
  }, /* @__PURE__ */ React54.createElement(CursorArrowIcon, null)), /* @__PURE__ */ React54.createElement(ToolButtonWithTooltip, {
    kbd: "2",
    label: intl.formatMessage({ id: "draw" }),
    onClick: selectDrawTool,
    isActive: activeTool === "draw" /* Draw */,
    id: "TD-PrimaryTools-Pencil"
  }, /* @__PURE__ */ React54.createElement(Pencil1Icon, null)), /* @__PURE__ */ React54.createElement(ToolButtonWithTooltip, {
    kbd: "3",
  ...
  }, /* @__PURE__ */ React54.createElement(ArrowTopRightIcon, null)), /* @__PURE__ */ React54.createElement(ToolButtonWithTooltip, {
    kbd: "9",
  ...
  }, /* @__PURE__ */ React54.createElement(TextIcon, null)), /* @__PURE__ */ React54.createElement(ToolButtonWithTooltip, {
    kbd: "0",
    label: intl.formatMessage({ id: "sticky" }),
    onClick: selectStickyTool,
    isActive: activeTool === "sticky" /* Sticky */,
    id: "TD-PrimaryTools-Pencil2"
  }, /* @__PURE__ */ React54.createElement(Pencil2Icon, null)));
});
...
function DMItem(_a) {
  ...
  return /* @__PURE__ */ React55.createElement(Item2, {
    dir: "ltr",
    asChild: true,
    onSelect,
    id
...
function DMCheckboxItem({
  ...
  return /* @__PURE__ */ React56.createElement(CheckboxItem, {
    dir: "ltr",
...
function DMContent({ sideOffset = 8, children, align, variant, id }) {
  return /* @__PURE__ */ React57.createElement(Content3, {
    dir: "ltr",
    align,
    sideOffset,
...
function DMSubMenu({ children, size, disabled = false, label, id }) {
  return /* @__PURE__ */ React58.createElement("span", {
    id
  }, /* @__PURE__ */ React58.createElement(Root3, {
    dir: "ltr"
  }, /* @__PURE__ */ React58.createElement(TriggerItem, {
    dir: "ltr",
    asChild: true
  }, /* @__PURE__ */ React58.createElement(RowButton, {
    disabled,
    hasArrow: true
  }, label)), /* @__PURE__ */ React58.createElement(Content4, {
    dir: "ltr",
    asChild: true,
    sideOffset: 2,
    alignOffset: -2
    ...
    size
  }, children, /* @__PURE__ */ React58.createElement(Arrow3, {
    offset: 13
  })))));
}
...
function DMTriggerIcon(_a) {
  ...
  return /* @__PURE__ */ React59.createElement(Trigger3, {
    asChild: true,
    id
...
function ActionButton() {
  ...
  return /* @__PURE__ */ React60.createElement(DropdownMenu2.Root, {
    ...
    variant: "circle"
  }, /* @__PURE__ */ React60.createElement(DotsHorizontalIcon, null))), /* @__PURE__ */ React60.createElement(DMContent, {
    sideOffset: 16
    ...
    kbd: `#D`,
    id: "TD-Tools-Copy"
  }, /* @__PURE__ */ React60.createElement(CopyIcon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
    onClick: handleRotate
  }, /* @__PURE__ */ React60.createElement(Tooltip, {
    label: intl.formatMessage({ id: "rotate" }),
    id: "TD-Tools-Rotate"
  }, /* @__PURE__ */ React60.createElement(RotateCounterClockwiseIcon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
    ...
    kbd: `#L`,
    id: "TD-Tools-Lock"
  }, isAllLocked ? /* @__PURE__ */ React60.createElement(LockClosedIcon, null) : /* @__PURE__ */ React60.createElement(LockOpen1Icon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
  ...
  }, isAllAspectLocked ? /* @__PURE__ */ React60.createElement(AspectRatioIcon, null) : /* @__PURE__ */ React60.createElement(BoxIcon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    ...
    kbd: `#G`,
    id: "TD-Tools-Group"
  }, /* @__PURE__ */ React60.createElement(GroupIcon, null)))), /* @__PURE__ */ React60.createElement(ButtonsRow, null, /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
  ...
  }, /* @__PURE__ */ React60.createElement(PinBottomIcon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
  ...
  }, /* @__PURE__ */ React60.createElement(ArrowDownIcon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
    ...
    kbd: `#]`,
    id: "TD-Tools-ArrowUp"
  }, /* @__PURE__ */ React60.createElement(ArrowUpIcon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
    ...
    kbd: `#\u21E7]`,
    id: "TD-Tools-PinTop"
  }, /* @__PURE__ */ React60.createElement(PinTopIcon, null))), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasSelection,
    onClick: handleResetAngle
  }, /* @__PURE__ */ React60.createElement(Tooltip, {
    label: intl.formatMessage({ id: "reset.angle" }),
    id: "TD-Tools-ResetAngle"
  }, /* @__PURE__ */ React60.createElement(AngleIcon, null)))), /* @__PURE__ */ React60.createElement(Divider, null), /* @__PURE__ */ React60.createElement(ButtonsRow, null, /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: alignLeft,
    id: "TD-Tools-AlignLeft"
  }, /* @__PURE__ */ React60.createElement(AlignLeftIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: alignCenterHorizontal,
    id: "TD-Tools-AlignCenterHorizontal"
  }, /* @__PURE__ */ React60.createElement(AlignCenterHorizontallyIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: alignRight,
    id: "TD-Tools-AlignRight"
  }, /* @__PURE__ */ React60.createElement(AlignRightIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: stretchHorizontally,
    id: "TD-Tools-StretchHorizontal"
  }, /* @__PURE__ */ React60.createElement(StretchHorizontallyIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasThreeOrMore,
    onClick: distributeHorizontally,
    id: "TD-Tools-SpaceEvenlyHorizontal"
  }, /* @__PURE__ */ React60.createElement(SpaceEvenlyHorizontallyIcon, null))), /* @__PURE__ */ React60.createElement(ButtonsRow, null, /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: alignTop,
    id: "TD-Tools-AlignTop"
  }, /* @__PURE__ */ React60.createElement(AlignTopIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: alignCenterVertical,
    id: "TD-Tools-AlignCenterVertical"
  }, /* @__PURE__ */ React60.createElement(AlignCenterVerticallyIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: alignBottom,
    id: "TD-Tools-AlignBottom"
  }, /* @__PURE__ */ React60.createElement(AlignBottomIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasTwoOrMore,
    onClick: stretchVertically,
    id: "TD-Tools-tretchVertical"
  }, /* @__PURE__ */ React60.createElement(StretchVerticallyIcon, null)), /* @__PURE__ */ React60.createElement(ToolButton, {
    disabled: !hasThreeOrMore,
    onClick: distributeVertically,
    id: "TD-Tools-SpaceEvenlyVertical"
  }, /* @__PURE__ */ React60.createElement(SpaceEvenlyVerticallyIcon, null))))));
}
...
function PreferencesMenu() {
  ...
  }, /* @__PURE__ */ React63.createElement(FormattedMessage, {
...
var Menu = React66.memo(function Menu2({ sponsor, readOnly }) {
  ...
  return /* @__PURE__ */ React66.createElement(DropdownMenu3.Root, {
  ...
  }, /* @__PURE__ */ React66.createElement(FormattedMessage2, {
    id: "new.project"
    ...
    id: "sponsored"
  }), "!", /* @__PURE__ */ React66.createElement(SmallIcon, null, /* @__PURE__ */ React66.createElement(HeartFilledIcon, null)))), showSignInOutMenu && /* @__PURE__ */ React66.createElement(React66.Fragment, null, /* @__PURE__ */ React66.createElement(DMDivider, {
    dir: "ltr"
    ...
    id: "menu.sign.out"
  }), /* @__PURE__ */ React66.createElement(SmallIcon, null, /* @__PURE__ */ React66.createElement(ExitIcon, null))))));
});
...
function PageOptionsDialog({ page, onOpen, onClose }) {
  ...
  return /* @__PURE__ */ React68.createElement(Dialog.Root, {
  ...
  }, /* @__PURE__ */ React68.createElement(FormattedMessage3, {
    id: "duplicate"
    ...
    asChild: true
  }, /* @__PURE__ */ React68.createElement(RowButton, null, /* @__PURE__ */ React68.createElement(FormattedMessage3, {
    id: "cancel"
  }))))));
}
...
function PageMenuContent({ onClose }) {
  ...
  return /* @__PURE__ */ React69.createElement(React69.Fragment, null, /* @__PURE__ */ React69.createElement(DropdownMenu4.RadioGroup, {
    ...
    asChild: true
  }, /* @__PURE__ */ React69.createElement(RowButton, null, /* @__PURE__ */ React69.createElement("span", null, /* @__PURE__ */ React69.createElement(FormattedMessage4, {
    id: "create.page"
  })), /* @__PURE__ */ React69.createElement(SmallIcon, null, /* @__PURE__ */ React69.createElement(PlusIcon, null)))));
}
...
var ZoomMenu = React70.memo(function ZoomMenu2() {
  ...
  return /* @__PURE__ */ React70.createElement(DropdownMenu5.Root, {
    ...
    kbd: "#+",
    id: "TD-Zoom-Zoom_In"
  }, /* @__PURE__ */ React70.createElement(FormattedMessage5, {
    id: "zoom.in"
  })), /* @__PURE__ */ React70.createElement(DMItem, {
    onSelect: preventEvent,
    onClick: app.zoomOut,
...
var StyleMenu = React71.memo(function ColorMenu() {
  ...
  return /* @__PURE__ */ React71.createElement(DropdownMenu6.Root, {
    ...
    variant: "text"
  }, /* @__PURE__ */ React71.createElement(FormattedMessage6, {
    id: "styles"
  ...
  }, /* @__PURE__ */ React71.createElement("span", null, /* @__PURE__ */ React71.createElement(FormattedMessage6, {
    id: "style.menu.color"
...
var MultiplayerMenu = React72.memo(function MultiplayerMenu2() {
  ...
  return /* @__PURE__ */ React72.createElement(DropdownMenu7.Root, {
    ...
    disabled: !room
  }, /* @__PURE__ */ React72.createElement(FormattedMessage7, {
    id: "copy.invite.link"
  }), /* @__PURE__ */ React72.createElement(SmallIcon, null, copied ? /* @__PURE__ */ React72.createElement(CheckIcon3, null) : /* @__PURE__ */ React72.createElement(ClipboardIcon, null))), /* @__PURE__ */ React72.createElement(DMDivider, {
...
var InnerMenu = React74.memo(function InnerMenu2({ onBlur }) {
  ...
  }, /* @__PURE__ */ React74.createElement(FormattedMessage8, {
    id: "duplicate"
...
var InnerTldraw = React78.memo(function InnerTldraw2({
  ...
  return /* @__PURE__ */ React78.createElement(IntlProvider, {
  ...
  }, /* @__PURE__ */ React78.createElement(Renderer, {
    id,
