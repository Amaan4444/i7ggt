...
__export(src_exports, {
  ...
  intersectRayPolygon: () => intersectRayPolygon,
  ...
  pointsToLineSegments: () => pointsToLineSegments
});
...
function intersectLineLine(AB, PQ) {
  const slopeAB = import_vec.Vec.slope(AB[0], AB[1]);
  const slopePQ = import_vec.Vec.slope(PQ[0], PQ[1]);
  if (slopeAB === slopePQ)
    return void 0;
