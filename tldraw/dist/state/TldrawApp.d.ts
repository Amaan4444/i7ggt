...
import { TDDocument, AlignType, StretchType, DistributeType, ShapeStyles, TDShape, TDShapeType, TDSnapshot, TDPage, TDBinding, TldrawCommand, TDUser, SessionType, TDToolType, TDAsset, TDAssets, TDExport, TDExportType } from '../types';
...
export declare class TldrawApp extends StateManager<TDSnapshot> {
    ...
    onPatch: (app: TDSnapshot, id?: string) => void;
    onCommand: (app: TDSnapshot, id?: string) => void;
    onReplace: () => void;
    onUndo: () => void;
    onRedo: () => void;
    onPersist: () => void;
     ...
     * Set a setting.
     */
    setSetting: <T extends "isDarkMode" | "showGrid" | "isSnapping" | "isCadSelectMode" | "isDebugMode" | "isPenMode" | "isReadonlyMode" | "isZoomSnap" | "keepStyleMenuOpen" | "nudgeDistanceSmall" | "nudgeDistanceLarge" | "isFocusMode" | "showRotateHandles" | "showBindingHandles" | "showCloneHandles" | "language", V extends {
        ...
        showGrid: boolean;
        language: import("../types").TDLanguage;
